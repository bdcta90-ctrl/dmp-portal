...
// ═══ Case 3~10 견적 검증 리포트 ═══
const UC3_ESTIMATE_RESPONSE = `## 🤖 AI 견적 검증 리포트 — BMW 5시리즈 (타사 B차) · 차선변경 과실 분쟁
...
| 시나리오 | 자사(A) | 타사(B) | 자사 부담 타사 수리비 | 타사 부담 자사 수리비 | 비고 |
|---------|---------|---------|---------------------|---------------------|------|
| **타사 주장** (100:0) | 100% | 0% | ₩1,230,000 | ₩0 | 차선변경차 전 과실 주장 |
| **AI 적정** (85:15) | 85% | 15% | ₩1,045,500 | ₩225,000 | 손보협 기준표 + 보정 |
| **보정안** (90:10) | 90% | 10% | ₩1,107,000 | ₩150,000 | 방향지시등 미사용 시 |

**1. 과실 기본 구조**
- 사고유형: 차선변경 — 동일방향 접촉
- 손보협 기준표 기본 과실: **A(차선변경차) 70% : B(직진차) 30%**
- 자사 A차가 차선변경 중이므로 기본 과실 불리

**2. 과실 보정 요소**
- A차 방향지시등 미사용/늦은 작동 시: **+10~15%** 가산 → 85:15
- B차 과속 또는 가속 증거 시: **-5~10%** 감산
- 블랙박스 확인 필수 — 진입 시점·속도·방향지시등 작동 여부

**3. 타사 100:0 주장 반박 근거**
- 대법원 판례: 직진차도 전방주시의무·회피의무 존재 → **0% 과실은 인정 불가** (대법원 2019다12345)
- 직진차 B의 과실 최소 10~15% 인정이 일반적

### 💵 과실비율별 총 비용 비교 (핵심 의사결정 테이블)

> 📌 사고 전제: 자사 수리비 ₩1,500,000 / 타사 수리비 ₩1,230,000(AI적정) / 자사 대인 치료비 ₩800,000+α / 타사 대인 치료비 ₩600,000+α

| 과실비율 | 대물(자사부담) | 대물(타사부담) | 대인(자) | 대인(타) | 자기부담금 | **총부담액(자사)** | 판단 기준 |
|---------|:------------:|:------------:|:-------:|:-------:|:---------:|:----------------:|----------|
| **85:15** | ₩1,045,500 | ₩1,275,000 | ₩120,000 | ₩510,000+α | ₩200,000 | **₩2,150,500+α** | 기본 — 대인 상계 후 순부담 |
| **90:10** | ₩1,107,000 | ₩1,350,000 | ₩80,000 | ₩540,000+α | ₩200,000 | **₩2,277,000+α** | 방향지시등 미사용 인정 시 |
| **100:0 (대인 접수)** | ₩1,230,000 | ₩1,500,000 | ₩0 | ₩600,000+α | ₩200,000 | **₩3,530,000+α** | 전과실 + 대인 비용 전액 |
| **🆕 100:0 (대인 미접수)** | ₩1,230,000 | ₩1,500,000 | **₩0** | **₩0** | ₩200,000 | **₩2,930,000** | ⭐ 대인 비용 제로 전략 |

### 🆕 💡 대인 미접수 전략 분석 (100:0 + 대인 미접수)

> **핵심 전략**: 100:0(자사 전과실)으로 양보하되, **양측 모두 대인을 접수하지 않는** 협상을 통해 총 비용을 최소화하는 방법

**전략 성립 조건:**
- ✅ 양측 부상이 **경미** (14급, 치료 2~3주 이하)
- ✅ 타사 대인 치료비+합의금이 **일정 금액 이하**면 유리
- ✅ 타사 고객이 대인 청구보다 **빠른 종결**을 선호하는 경우

**손익 분기점 분석:**
| 비교 | 85:15 (대인 접수) | 100:0 (대인 미접수) | 차이 |
|------|:-----------------:|:------------------:|:----:|
| 대물 자사 부담 | ₩1,045,500 | ₩1,230,000 | +₩184,500 |
| 대인 자사 부담 | ₩510,000+α | **₩0** | **▼ ₩510,000+α** |
| 자기부담금 | ₩200,000 | ₩200,000 | ₩0 |
| **총 부담** | **₩2,150,500+α** | **₩2,930,000** | |

> ⚠️ **분기점**: 타사 대인 치료비+합의금이 **₩780,000 이하**이면 85:15가 유리.
> **₩780,000 초과** 시 100:0 대인 미접수가 유리.
>
> 경상(14급) 평균 합의금 ₩500,000~₩1,500,000 수준을 감안하면,
> **대인 미접수 전략이 유리할 확률이 높음**.

**100:0 대인 미접수 시 장점:**
1. 💰 대인 비용 **완전 제로** (자사+타사 모두)
2. ⏱️ 처리 기간 대폭 단축 (대인 합의 불필요 → 2~3일 내 종결 가능)
3. 😊 고객 만족도 상승 (빠른 처리 + 할증 최소화)
4. 📉 보험 할증 영향 감소 (대인 미접수 = 사고 등급 하향)

**100:0 대인 미접수 시 위험:**
1. ⚠️ 타사가 나중에 대인 접수 가능 (14일 이내)
2. ⚠️ 타사 부상이 예상보다 심할 경우 불리
3. ⚠️ 자사 고객의 향후 치료 비용 자부담

**🗣️ 타사 협상 스크립트:**
> "저희가 100% 과실을 인정하겠습니다. 대신 양측 모두 대인은 접수하지 않는 것으로 합의하면,
> 차량 수리는 빠르게 진행하고 양쪽 모두 보험료 할증을 최소화할 수 있습니다.
> 치료비는 각자 부담하시는 것이 양측 모두에게 유리한 방향입니다."

### 📈 4가지 시나리오 최종 비교

| 순위 | 시나리오 | 총 비용 | 처리 기간 | 분쟁 리스크 | 추천 |
|:----:|---------|:-------:|:---------:|:----------:|:----:|
| 1 | **🆕 100:0 대인 미접수** | **₩2,930,000** | 2~3일 | 낮음 | ⭐ **최적** |
| 2 | 85:15 적정 | ₩2,150,500+α | 2~4주 | 중간 | 차선 |
| 3 | 90:10 협의 | ₩2,277,000+α | 1~2주 | 낮음 | 안전 |
| 4 | 100:0 대인 접수 | ₩3,530,000+α | 1~2주 | 낮음 | 비추천 |

### ✅ AI 최종 권고
> **🆕 100:0 대인 미접수 전략 추천** — 총 비용 **₩2,930,000** (확정, +α 없음)
>
> 경상(14급) 수준의 경미 사고에서는 과실 분쟁(85:15)보다 **100:0으로 양보하되 대인을 미접수**하는 것이
> 총 비용·처리 기간·고객 만족도 모든 측면에서 유리합니다.
>
> 단, 타사 부상 상태가 14급 이상(13급~)이거나, 타사 고객이 합의를 거부할 경우
> **85:15 과실 분쟁으로 전환**해야 합니다.`;
