...
### 💵 자사 부담 시나리오 (AI 적정 85:15 기준)

| 구분 | 금액 |
|------|------|
| 타사 B차 수리비 (85%) | ₩1,045,500 |
| 자사 A차 수리비 (자차) | ₩1,500,000 |
| 타사에서 회수 (15%) | ▼ ₩225,000 |
| **자사 총 부담** | **₩2,320,500** |

### ✅ 종합 의견
> 차선변경 과실 분쟁 사건. 타사 B차 BMW 5시리즈 수리비 ₩1,960,000 청구 중 **₩730,000 과다**.
> 범퍼·펜더 모두 판금 복원 가능 수준이나 교체로 청구. 과실은 **85:15가 적정**이며,
> 타사 100:0 주장은 직진차 회피의무 판례로 반박 가능. 블랙박스 확보가 핵심.`;
