...
function TabData(){
  ...
  const cds=[{bg:"#0891b2",lbg:"#ecfeff",nm:"차량"},{bg:"#059669",lbg:"#ecfdf5",nm:"서비스센터"},{bg:"#7c3aed",lbg:"#f5f3ff",nm:"렌터카"},{bg:"#ea580c",lbg:"#fff7ed",nm:"부품"}];
  const cd=cds[dk];
  // ═══ 엑셀 다운로드 ═══
  ...
  return(<div style={{height:"100%",display:"flex",flexDirection:"column",gap:8}}>
    ...
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"4px 0"}}>
      <div style={{fontSize:9,color:"#94a3b8"}}>💡 엑셀 파일(.xlsx)을 업로드하면 전체 데이터를 조회할 수 있습니다. 다운로드로 현재 데이터를 내보낼 수 있습니다.</div>
      <div style={{display:"flex",gap:6}}>
