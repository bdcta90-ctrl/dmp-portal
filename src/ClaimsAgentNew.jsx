...
const DK=["차량DB","서비스센터DB","렌터카DB","부품DB","약관기준DB"];
...
function TabData(){
  ...
  const cds=[{bg:"#0891b2",lbg:"#ecfeff",nm:"차량"},{bg:"#059669",lbg:"#ecfdf5",nm:"서비스센터"},{bg:"#7c3aed",lbg:"#f5f3ff",nm:"렌터카"},{bg:"#ea580c",lbg:"#fff7ed",nm:"부품"},{bg:"#b45309",lbg:"#fffbeb",nm:"약관기준"}];
  const cd=cds[dk];
  // ═══ 엑셀 다운로드 ═══
  ...
  const downloadDataMap=()=>{
    ...
    const summary=[["#","데이터 분류","데이터명","규모","용도"],
      ...
      [15,"데이터 뷰어","DATASETS","5개DB / 118,902건","임베드 데이터"],
    ];
