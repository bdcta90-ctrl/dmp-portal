...
| **AI 적정 수리비** | — | **₩17,000,000~20,000,000** |
| **렌트** | 그랜저 동급 ✅ 적정 | **BMW 7시리즈 ⚠️ 부적정** |
| **대인** | 2명 | 3명 |
| **과실 주장** | A 30 : B 70 | A 70 : B 30 |

---

## ⚠️ 핵심 쟁점 분석

### 1️⃣ 과실 비율 — 30:70 vs 70:30 극단 대립

> **AI 판정: A(자사) 45~50% : B(타사) 50~55% 이 적정**

- 교차로 골목길 쌍방 진입 → 손해보험협회 기준 **기본 과실 50:50**
- 양측 "먼저 진입" / "상대 과속" 주장 → **증거 미확보로 중립 처리**
- "주도로" 분쟁 → 도로 폭 **1.5배 이상** 차이 시 주도로 인정 (손해보험협회 기준), 주도로 진입차에 **10~15% 감경**
- ⚠️ 도로 폭·교통량 데이터 미확인 → **현장 확인 필수**

### 2️⃣ BMW 수리비 **₩25,000,000** → 과다 청구 의심

| 항목 | 타사 청구 | AI 적정 추정 | **차이** |
|------|----------|-------------|---------|
| BMW OEM 부품 | 국산 대비 2.8~3.5배 | 반영 완료 | — |
| 유사사고 5건 평균 | — | ₩17,000,000~20,000,000 | — |
| **과다 청구 추정** | ₩25,000,000 | ₩18,500,000 (중앙값) | **▼ ₩5,000,000~8,000,000** |

> **💡 세부 항목별 단가 대조 필요 — 견적 산정 Agent 연계 검증 권고**

### 3️⃣ 렌트 등급 — BMW 7시리즈 요구는 부적정

| 구분 | 타사 요구 | AI 적정 | **절감액 (14일 기준)** |
|------|----------|--------|---------------------|
| 렌트 차종 | BMW 7시리즈 | **BMW 5시리즈 (동급)** | — |
| 일 렌트비 | ₩350,000~400,000 | ₩200,000~250,000 | — |
| 14일 총액 | ₩4,900,000~5,600,000 | ₩2,800,000~3,500,000 | **▼ ₩2,100,000** |

- 법적 근거: 대법원 "**동종·동급**" 원칙 → 7시리즈급 렌트는 시장 희소, 5시리즈가 적정
- ⚠️ 타사가 7시리즈 고집 시 → 판례 제시 후 과실심의위 회부 가능

### 4️⃣ 대인 5명 — 일괄 합의 패키지 필수
...
> **💡 자사 부담분 = 과실 비율에 따라 크게 변동 → "일괄 합의 패키지"로 총액 ₩10,000,000 이내 목표**

---

## 💰 자사 보험사 손실 시뮬레이션

### 과실 비율별 자사 보험사 총 지출 추정

| | **타사 주장 (70:30)** | **AI 적정 (50:50)** | **자사 주장 (30:70)** |
|------|------|------|------|
| 타사 수리비 (₩25M 기준) | ₩17,500,000 | ₩12,500,000 | ₩7,500,000 |
| 타사 렌트 (5시리즈 정정) | ₩2,450,000 | ₩1,750,000 | ₩1,050,000 |
| 타사 대인 3명 | ₩6,300,000 | ₩4,500,000 | ₩2,700,000 |
| 자사 차량 순부담 | ₩3,500,000 | ₩2,500,000 | ₩1,500,000 |
| 자사 렌트 | ₩700,000 | ₩700,000 | ₩700,000 |
| **자사 보험사 총 지출** | **₩30,450,000** | **₩21,950,000** | **₩13,450,000** |

> **✅ AI 적정(50:50) + 수리비 협상(₩18.5M) 적용 시 → 총 ₩18,700,000 (타사 주장 대비 ▼ ₩11,750,000 절감 가능)**

### ⚡ 핵심 요약

- **가장 큰 변수**: 과실 비율 (70:30→50:50 전환만으로 **₩8,500,000 절감**)
- **즉시 실행 가능**: 렌트 등급 정정 (7시리즈→5시리즈, **₩2,100,000 절감**)
- **검증 필요**: BMW 수리비 적정성 (과다 청구 **₩5,000,000~8,000,000 추정**)
- **전략 필요**: 대인 5명 일괄 합의 (개별 처리 시 총액 통제 불가)`;
