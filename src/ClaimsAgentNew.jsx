...
| 본넷(후드) | ₩2,800,000 | 교체 | — | 판금+도장 *(범퍼에 포함)* | **▼ ₩2,800,000** |
| 라디에이터+에어컨 | ₩2,500,000 | 교체 | ₩2,500,000 | 교체 ✅ | ₩0 |
| 도장 (4면) | ₩3,200,000 | — | ₩2,100,000 | — | **▼ ₩1,100,000** |
| 공임비 | ₩4,600,000 | — | ₩2,650,000 | — | **▼ ₩1,950,000** |
...
// ═══ Case 3~10 견적 검증 리포트 ═══
const UC3_ESTIMATE_RESPONSE = `## 🤖 AI 견적 검증 리포트 — BMW 5시리즈 (타사 B차)
...
| 파손 부위 | 타사 청구 | 수리방법(타사) | AI 적정 | 수리방법(AI) | **차이** |
|----------|----------|---------------|---------|-------------|---------|
| 프론트 범퍼(상) 좌측 | ₩650,000 | 교체 | ₩380,000 | 판금+도장 | **▼ ₩270,000** |
| 좌 프론트 펜더 | ₩550,000 | 교체 | ₩350,000 | 판금+도장 | **▼ ₩200,000** |
| 도장 (2면) | ₩480,000 | — | ₩320,000 | — | **▼ ₩160,000** |
| 공임비 | ₩280,000 | — | ₩180,000 | — | **▼ ₩100,000** |
| **합계** | **₩1,960,000** | | **₩1,230,000** | | **▼ ₩730,000** |

### 🔍 부위별 수리/교환 판단

**1. 프론트 범퍼(상) — 판금+도장 권장 (교체 불필요)**
- 타사 주장: 범퍼 교체 ₩650,000
- AI 판단: 좌측 하단 접촉 변형 → **판금+부분도장으로 복원 가능** (변형 깊이 5mm 이하)
- BMW 520i 순정 범퍼 ₩520,000 + 공임 ₩130,000 = ₩650,000은 교체 전제
- 판금 시 ₩380,000 → **₩270,000 절감**

**2. 좌 프론트 펜더 — 판금+도장 권장**
- 타사 주장: 펜더 교체 ₩550,000
- AI 판단: 경미 찌그러짐 + 스크래치 수준 → **판금 복원 충분** (절단선 없음)
- 외산 ×1.6 적용해도 판금이 적정
- 판금 시 ₩350,000 → **₩200,000 절감**

**3. 도장 — 2면 적정 (과다 없음, 단가 보정)**
- 타사 청구 면당 ₩240,000 → AI 적정 ₩160,000
- BMW 외산 도장 배수 적용해도 ₩160,000/면이 시장 기준

### 🚗 렌트(대차) 검증
| 항목 | 타사 요구 | AI 적정 |
|------|----------|---------|
| 대차 차종 | BMW 5시리즈 동급 | BMW **3시리즈** 동급 (사고 부위 경미) |
| 일 렌트비 | ₩225,000 | ₩160,000 |
| 수리 기간 | 7일 | 5~7일 (판금 시 단축) |
| **렌트 총비용** | **₩1,575,000** | **₩960,000** |

> 차선변경 접촉으로 파손 범위가 제한적 → 수리 기간 단축 가능 → 렌트비 절감

### 💵 미수선(현금정산) 제안
- AI 적정 견적 ₩1,230,000의 70~80%
- **현금정산 범위: ₩861,000 ~ ₩984,000**
- 경미~중간 손상이므로 미수선 처리 적합

### ✅ 종합 의견
> BMW 5시리즈 수리비 ₩1,960,000 청구 중 **₩730,000 과다** (37% 할인 가능).
> 범퍼·펜더 모두 **판금+도장으로 충분한 수준**이나 교체로 청구.
> AI 적정 **₩1,230,000** + 렌트 **₩960,000** = 총 **₩2,190,000**
> (타사 주장 ₩3,535,000 대비 **₩1,345,000 절감**)`;

const UC3_ESTIMATE_SELF = `## 🤖 AI 견적 분석 리포트 — 자사 차량 (현대 그랜저)
...
| 추정 주행거리 | 약 35,000km |
| 차량가액 | 약 **₩32,000,000** |
| 보험 처리 | 자차보험 + 상대방 대물배상 (과실 85:15) |

### 📊 자사 차량 파손 분석

> **사고 상황**: 차선변경 중 BMW 5시리즈와 접촉. 자사 그랜저는 **우측 후방부**가 파손됨.

| 파손 부위 | 손상도 | 수리 방법 | 예상 비용 |
|----------|--------|----------|----------|
| 리어 범퍼(상) 우측 | 중간 | 판금 도장 | **₩450,000** |
| 우 리어쿼터패널 | 중간 | 판금 도장 | **₩550,000** |
| 우 리어 도어(하단) | 경미 | 경미 접촉 수리 | **₩300,000** |
| **합계** | | | **₩1,300,000** |

### 🔧 수리 방법 권고

**판금 도장 수리 권장** (교체 불필요)
- 범퍼·쿼터패널 모두 변형 깊이 5mm 이하 → **판금 수리로 충분**
- 리어 도어는 하단 경미 접촉으로 부분 수리 가능
- 제휴 서비스센터 이용 시 추가 **15% 절감** 가능 (₩1,105,000)
...
### 💡 자사 고객 부담 안내
- 과실 85:15이므로 **타사 대물배상에서 15% 보상** 가능
- 자사 수리비 ₩1,300,000 × 15% = ₩195,000 (타사에서 회수)
- 자사 실부담: ₩1,300,000 - ₩195,000 = **₩1,105,000** (자차보험 처리)
- 자기부담금: **₩200,000~500,000**
- ⚠️ 고객 안내: **"본인 부담은 자기부담금(₩20~50만원)이며, 나머지는 자차보험으로 처리됩니다"**`;

const UC3_ESTIMATE_TOTAL = `## 📊 보험사 총 지출 요약 — Case 3 종합

### 💰 자사 보험사 총 예상 지출

| 구분 | 항목 | AI 적정 | 타사 청구 | 차이 |
|------|------|---------|----------|------|
| **타사 차량 (BMW 5)** | 수리비 | ₩1,230,000 | ₩1,960,000 | ▼ ₩730,000 |
| | 렌트비 (3시리즈 동급) | ₩960,000 | ₩1,575,000 | ▼ ₩615,000 |
| **자사 차량 (그랜저)** | 수리비 | ₩1,300,000 | — | — |
| | 렌트비 (그랜저 동급) | ₩660,000 | — | — |
| **대인 배상** | 타사 1명 (12급) | ₩3,000,000 | ₩5,000,000 | ▼ ₩2,000,000 |
| | 자사 1명 (12급) | ₩300,000 | — | — |
...
| 시나리오 | 타사 손해 부담 | 자사 차량 | 대인 | **총 비용** | **절감액** |
|---------|--------------|----------|------|-----------|----------|
| **A. 타사 주장 수용 (0:100)** | ₩3,535,000 | ₩1,300,000 | ₩5,000,000 | **₩9,835,000** | — |
| **B. AI 85:15 + 수리비 협상** (권고) | ₩1,862,000 | ₩1,105,000 | ₩2,850,000 | **₩4,725,000** | **▼ ₩5,110,000** |
| **C. 100:0 + 대인 미접수** (전략) | ₩2,190,000 | ₩1,300,000 | ₩0 | **₩2,930,000** | **▼ ₩6,905,000** |

### ⚠️ 핵심 쟁점 3가지

**1. 과실 분쟁 (0:100 vs 85:15)**
- 타사 0:100 주장 → AI 판정 85:15 (₩5,110,000 절감)
- 대법원 판례: 직진 차량에도 전방주시의무 존재, 10:0 불인정

**2. BMW 수리비 과다 청구 (₩730,000)**
- 범퍼·펜더 교체 청구 → AI 판단: 판금+도장 충분
- 도장 단가 과다 (면당 ₩240,000 → 적정 ₩160,000)

**3. 대인 미접수 전략 (₩5,000,000 절감)**
- 100:0 전과실 인정 대신 양측 대인 미접수 → 대인 비용 전액 제거
- 총 비용 ₩2,930,000으로 최대 절감

### ✅ AI 최종 권고

> **B안 (85:15 + 수리비 협상)** 추천 — 총 **₩4,725,000**
>
> 타사 0:100 주장 수용 시 대비 **₩5,110,000 절감**. 과실 85:15를 관철하고
> BMW 수리비 과다 항목(₩730,000)과 렌트 정정(₩615,000)으로 절감.
> 전략안(C) 추진 시 ₩2,930,000까지 절감 가능하나 타사 합의 필요.

### 🗣️ 자사 고객 안내 스크립트

> "고객님, 상대방 보험사에서 전액 과실을 주장하고 있으나, AI 분석 결과 **85:15가 적정**합니다.
> 고객님 차량 수리비도 보험으로 처리되며, **실제 본인 부담은 자기부담금(₩20~50만원)** 수준입니다.
> 상대방 수리비도 전문 검증하여 과다 청구 항목을 시정 요청 중입니다."`;

const UC4_ESTIMATE_RESPONSE = `## 🤖 AI 견적 검증 리포트 — 음주+12대중과실+무보험 (K5 vs 투싼)

### 📋 사고 개요
| 항목 | 내용 |
|------|------|
| 자사 A차 | **기아 K5** (2021, 45,000km) |
| 타사 B차 | **현대 투싼** (2022, 28,000km, **무보험**) |
| 과실 | **자사 100% : 타사 0%** |
| 특수사항 | 🍺 **음주운전 (BAC 0.08%)** · 12대 중과실(신호위반) |

### 🚨 음주 면책 적용

| 보험 종목 | 보상 여부 | 사유 |
|----------|----------|------|
| 대인배상Ⅰ (의무) | ✅ 보상 | 피해자 보호 (자배법, 면책 불가) |
| 대인배상Ⅱ (임의) | ❌ **면책** | 음주운전 면책 (약관 제19조) |
| 대물배상 | ❌ **면책** | 음주운전 면책 |
| 자기차량손해 | ❌ **면책** | 음주운전 면책 |
| 자기신체사고 | ❌ **면책** | 음주운전 면책 |

> ⚠️ **자사 K5 수리비 ₩8,500,000은 자차보험 면책 → 고객 100% 자비 부담**

### 📊 타사 B차 (투싼) 파손 분석 — 무보험

| 파손 부위 | 손상도 | 수리방법 | 예상 비용 |
|----------|--------|---------|----------|
| 프론트 범퍼(상) | 심각 | 교체 | ₩450,000 |
| 프론트 범퍼(하/립) | 심각 | 교체 | ₩280,000 |
| 우 프론트 펜더 | 심각 | 판금 교체 | ₩520,000 |
| 우 헤드라이트 | 심각 | 교체 | ₩480,000 |
| 프론트 그릴 | 심각 | 교체 | ₩180,000 |
| 본넷 | 심각 | 판금 교체 | ₩680,000 |
| 도장 (4면) | — | 전면 도장 | ₩850,000 |
| 공임 | — | — | ₩760,000 |
| **합계** | | | **₩4,200,000** |
...
| 피해자 | 상해등급 | 치료일수 | 예상 합의금 | 보상 경로 |
|--------|---------|---------|-----------|----------|
| 타사 운전자 | **8급** (중상) | 56일 | ₩12,000,000~15,000,000 | 대인Ⅰ(의무) |
| 타사 동승자1 | **10급** (경상) | 21일 | ₩3,500,000~5,000,000 | 대인Ⅰ(의무) |
| 타사 동승자2 | **12급** (경상) | 14일 | ₩1,800,000~2,500,000 | 대인Ⅰ(의무) |
| **합계** | | | **₩17,300,000~22,500,000** | |

> ⚠️ 대인Ⅱ 면책 → 대인Ⅰ 한도(1.5억) 초과 시 자사 고객 개인 부담

### 🏛️ 무보험 B차 → 정부보장사업 안내

- 타사 B차 **무보험** → 타사 피해자는 **정부보장사업**(자배법 제30조)으로 보상 청구 가능
- 자사 대인Ⅰ(의무)로 우선 보상 후, 정부보장사업에서 초과분 보전
- 대물(B차 수리비)은 **대물배상 면책** → 자사 고객이 직접 배상해야 함

### 💰 자사 고객 부담 총 정리

| 구분 | 금액 | 비고 |
|------|------|------|
| 자사 K5 수리비 (자비) | ₩8,500,000 | 자차보험 면책 |
| 타사 투싼 수리비 (자비) | ₩4,200,000 | 대물배상 면책 |
| 대인 초과분 (개인) | ₩0~₩5,000,000 | 대인Ⅰ 한도 내 해결 가능성 높음 |
| 벌금/면허정지 | 별도 | 음주 BAC 0.08% → 면허정지 |
| **총 예상 부담** | **₩12,700,000~₩17,700,000** | |

### ✅ 종합 의견
> 음주+12대중과실 사고로 **대물·자차·자기신체 전면 면책**. 자사 고객은 자기 차량 수리비(₩8.5M) +
> 타사 수리비(₩4.2M)를 직접 부담해야 합니다. 대인Ⅰ(의무)만 보상 가능하며, 8급 중상 피해자가 있어
> 합의금이 ₩17~22M 수준으로 예상됩니다. 고객에게 **면책 사유를 명확히 안내**하고,
> 타사 피해자에게는 **정부보장사업 절차를 안내**해야 합니다.`;

const UC5_ESTIMATE_RESPONSE = `## 🤖 AI 견적 검증 리포트 — 렌터카 영업차량 휴차료 (쏘나타 vs 스포티지)

### 📋 사고 개요
| 항목 | 내용 |
|------|------|
| 자사 A차 | **현대 쏘나타** (2024, 12,000km, **렌터카/영업용**) |
| 타사 B차 | **기아 스포티지** (2023, 32,000km, 가해차량) |
| 과실 | **자사 0% : 타사 100%** (자사 피해자) |
| 핵심 쟁점 | 🚕 **영업용 차량 → 렌트비가 아닌 휴차료(영업손실)** |

### 📊 자사 A차 (쏘나타 렌터카) 파손 분석

| 파손 부위 | 손상도 | 수리방법 | 예상 비용 |
|----------|--------|---------|----------|
| 리어 범퍼(상) | 중간 | 판금+도장 | ₩380,000 |
| 리어 범퍼(하/디퓨저) | 중간 | 교체 | ₩250,000 |
| 트렁크/테일게이트 | 중간 | 판금+도장 | ₩650,000 |
| 좌 리어램프 | 중간 | 교체 | ₩320,000 |
| 우 리어램프 | 중간 | 교체 | ₩320,000 |
| 리어 유리 | 중간 | 교체 | ₩280,000 |
| 도장+공임 | — | — | ₩1,000,000 |
| **합계** | | | **₩3,200,000** |
...
| 항목 | 산정 근거 | 금액 |
|------|----------|------|
| 일일 매출액 | 렌터카 일 대여료 | ₩180,000 |
| 가동률 | 연평균 가동률 85% | ×0.85 |
| 일일 영업이익 | ₩180,000 × 85% | ₩153,000 |
| 수리 기간 | 12일 | ×12 |
| 고정비 공제 | 월 고정비 ₩2,800,000 ÷ 30일 × 12일 | ▼ ₩1,120,000 |
| **휴차료 합계** | (₩153,000 × 12) - ₩1,120,000 | **₩716,000** |

> ⚠️ **렌터카는 일반 렌트비(대차료)가 아닌 휴차료로 청구해야 함**
> - 일반 차량: 수리 기간 동안 **동종동급 렌트비** 청구
> - 영업용 차량: 수리 기간 동안 **영업손실(휴차료)** 청구
> - 대법원 판례(2018다245678): 영업용 차량은 실제 영업이익 손실 기준

### 📊 타사 B차 (스포티지) 파손 분석

| 파손 부위 | 예상 비용 | 비고 |
|----------|----------|------|
| 프론트 범퍼(상+하) | ₩580,000 | 판금+도장 |
| 본넷 | ₩450,000 | 판금+도장 |
| 프론트 그릴 | ₩180,000 | 교체 |
| 라디에이터 점검 | ₩120,000 | 누수 시 교체 |
| 공임+도장 | ₩470,000 | — |
| **합계** | **₩1,800,000** | 타사 100% 부담 |

### 💰 자사 보험사 청구 총액 (타사에서 회수)

| 구분 | 금액 | 비고 |
|------|------|------|
| 자사 쏘나타 수리비 | ₩3,200,000 | 타사 100% 부담 |
| 휴차료 (영업손실) | ₩716,000 | 영업이익 기준 산정 |
| **타사에 청구 총액** | **₩3,916,000** | |

### ✅ 종합 의견
> 렌터카 영업차량 사고로 타사 100% 과실. 핵심은 **렌트비가 아닌 휴차료 산정**.
> 일 매출 ₩180,000 × 가동률 85% × 12일 - 고정비 = **₩716,000**이 적정 휴차료.
> 수리비 ₩3,200,000 + 휴차료 ₩716,000 = **₩3,916,000**을 타사에 전액 청구.
> 가동률·매출 증빙서류(매출대장, 배차기록) 확보가 필수.`;

const UC6_ESTIMATE_RESPONSE = `## 🤖 AI 견적 검증 리포트 — 3중 추돌 다수 과실 배분 (그랜저→K8→스포티지)

### 📋 사고 개요
| 항목 | A차 (자사) | B차 (중간) | C차 (선두) |
|------|----------|----------|----------|
| 차종 | 현대 그랜저 | 기아 K8 | 기아 스포티지 |
| 연식 | 2023 | 2024 | 2022 |
| 과실 | **70%** | **20%** | **10%** |
| 위치 | 후미 (추돌) | 중간 (피추돌+추돌) | 선두 (피추돌) |

### 📊 3대 차량 파손 및 수리비

| 차량 | 파손 부위 | 수리비 | 비고 |
|------|----------|--------|------|
| **A차 (그랜저)** | 전면 범퍼+본넷+헤드라이트+그릴, 후면 범퍼+트렁크+리어램프 | **₩8,500,000** | 전후면 양쪽 파손 |
| **B차 (K8)** | 전면 범퍼ASSY+본넷+그릴+라디에이터, 후면 범퍼ASSY+트렁크+리어램프×2 | **₩14,200,000** | 전후면 대파 (중간차) |
| **C차 (스포티지)** | 후면 범퍼+트렁크+리어램프 | **₩4,500,000** | 후면부 파손 |

> ⚠️ **B차(K8)가 중간차로 전면+후면 양쪽 대파 → 수리비 최대 (₩14.2M)**

### 🔄 6방향 비용 흐름 (과실 배분)

| 배상 방향 | 산식 | 금액 |
|----------|------|------|
| **A→B** (A가 B에 배상) | B차 ₩14.2M × A과실 70% × (1-B과실20%) | **₩7,952,000** |
| **A→C** (A가 C에 배상) | C차 ₩4.5M × A과실 70% | **₩3,150,000** |
| **B→A** (B가 A에 배상) | A차 ₩8.5M × B과실 20% | **₩1,700,000** |
| **B→C** (B가 C에 배상) | C차 ₩4.5M × B과실 20% | **₩900,000** |
| **C→A** (C가 A에 배상) | A차 ₩8.5M × C과실 10% | **₩850,000** |
| **C→B** (C가 B에 배상) | B차 ₩14.2M × C과실 10% | **₩1,420,000** |

### 💰 각 보험사 순부담

| 보험사 | 지출 (배상) | 회수 | **순부담** |
|--------|-----------|------|----------|
| **A사 (자사)** | ₩7,952,000 + ₩3,150,000 = ₩11,102,000 | ₩1,700,000 + ₩850,000 = ₩2,550,000 | **₩8,552,000** |
| **B사** | ₩1,700,000 + ₩900,000 = ₩2,600,000 | ₩7,952,000 + ₩1,420,000 = ₩9,372,000 | **▼ ₩6,772,000** (회수 초과) |
| **C사** | ₩850,000 + ₩1,420,000 = ₩2,270,000 | ₩3,150,000 + ₩900,000 = ₩4,050,000 | **▼ ₩1,780,000** (회수 초과) |

### 👨‍⚕️ 대인 피해자 4명

| 피해자 | 차량 | 등급 | 치료일수 | 예상 합의금 |
|--------|------|------|---------|-----------|
| B차 운전자 | K8 | 10급 | 28일 | ₩3,500,000 |
| B차 동승자 | K8 | 12급 | 14일 | ₩1,800,000 |
| C차 운전자 | 스포티지 | 12급 | 10일 | ₩1,500,000 |
| C차 동승자 | 스포티지 | 14급 | 7일 | ₩800,000 |
| **합계** | | | | **₩7,600,000** |

### ✅ 종합 의견
> 3중 추돌 사고로 자사(A) 70% 과실. B차(K8)가 중간차로 전후면 대파 ₩14.2M이 최대 쟁점.
> 자사 순부담 **₩8,552,000** + 대인 분담금 예상. 6방향 구상금 정산이 복잡하므로
> 3사 간 일괄 합의(net settlement) 추진이 효율적. B차 수리비 과다 청구 여부 검증 필수.`;

const UC7_ESTIMATE_RESPONSE = `## 🤖 AI 견적 검증 리포트 — 전부손해(전손)+할부 정산 (모하비 전복)
...
| 사고유형 | **고속도로 전복 (단독사고)** |
| 과실 | **자사 100%** (단독) |
| 특수사항 | 🏦 **할부 잔금 ₩18,000,000** (현대캐피탈) |

### 📊 전손 판정 분석

| 항목 | 금액 | 비고 |
|------|------|------|
| 추정 수리비 | ₩42,000,000 | 루프+필러+서브프레임 등 11개 부위 |
| 차량가액 | ₩48,000,000 | 보험개발원 기준가액 |
| **수리비/가액 비율** | **87.5%** | ⚠️ 80% 초과 → **전손 처리** |

> 📌 **전부손해(전손) 기준**: 수리비가 차량가액의 **80% 초과** 시 전손 처리 (보통약관)
> 수리비 ₩42M / 차량가액 ₩48M = **87.5%** → 전손 확정
...
|------|--------|------|
| 루프패널 | 전손 | 완전 붕괴 |
| 좌 A/B/C필러 | 전손 | 전수 변형 (구조물) |
| 좌 프론트/리어 도어 | 전손 | 압착 변형 |
| 좌 사이드실(로커패널) | 전손 | 구조물 파손 |
| 프론트 서브프레임 | 전손 | 하부 골격 손상 |
| 플로어패널 | 전손 | 바닥 변형 |
| 좌 전륜/후륜 휠+타이어 | 전손 | 현가장치 포함 |

### 💰 전손 정산 계산

| 항목 | 금액 | 산식 |
|------|------|------|
| 차량가액 | ₩48,000,000 | 보험개발원 기준 |
| 잔존물 가치 (8%) | ▼ ₩3,840,000 | ₩48M × 8% |
| **보험금 총액** | **₩44,160,000** | 가액 - 잔존물 |
| 할부잔금 (현대캐피탈) | ▼ ₩18,000,000 | **우선변제** |
| **고객 실수령액** | **₩26,160,000** | 보험금 - 할부잔금 |

### 🏦 할부 우선변제 안내

- **질권 설정**: 할부 차량은 할부사(현대캐피탈)가 보험금 수령 1순위
- **보험금 지급 순서**: ① 할부잔금 ₩18,000,000 → 현대캐피탈 직접 지급 → ② 잔액 ₩26,160,000 → 고객 지급
- **고객 동의 필요**: 잔존물 처리(보험사 인수 vs 고객 보유) 선택
- 고객이 잔존물 보유 시: 보험금 ₩44,160,000 - 잔존물 ₩3,840,000 = ₩40,320,000 지급

### 🏗️ 시설물(가드레일) 배상

| 항목 | 예상 비용 |
|------|----------|
| 가드레일 복구 | ₩2,000,000~5,000,000 |
| 노면 복구 | ₩500,000~1,000,000 |
| **시설물 배상 총액** | **₩2,500,000~6,000,000** |

> 도로관리청(한국도로공사 등)에서 별도 청구 예정

### 👨‍⚕️ 대인 피해 (자사 탑승자 2명)

| 피해자 | 등급 | 치료일수 | 예상 보상 | 보상 경로 |
|--------|------|---------|----------|----------|
| 자사 운전자 | **5급** (중상) | 90일 | ₩15,000,000~20,000,000 | 자기신체사고 특약 |
| 자사 동승자 | **8급** (중간) | 42일 | ₩8,000,000~12,000,000 | 자기신체사고 특약 |

### ✅ 종합 의견
> 고속도로 전복 단독사고. 수리비/가액 87.5% → **전손 확정**. 보험금 ₩44,160,000 중
> 할부잔금 ₩18,000,000이 현대캐피탈에 **우선변제**되어 고객 실수령 **₩26,160,000**.
> 시설물 배상 ₩2.5~6M 별도 발생. 5급 중상 탑승자 장기 치료비 산정 필요.
> 고객에게 할부 우선변제 구조와 잔존물 처리 옵션을 명확히 안내해야 합니다.`;

const UC8_ESTIMATE_RESPONSE = `## 🤖 AI 견적 검증 리포트 — 사망사고 종합 (스타리아 vs 대형트럭)

### 📋 사고 개요
| 항목 | A차 (자사) | B차 (타사) |
|------|----------|----------|
| 차종 | 현대 스타리아 9인승 | 대형 카고트럭 |
| 연식 | 2024 | 2020 |
| 과실 | **30%** | **70%** |
| 사고유형 | 고속도로 다중 충돌 |
| 특수사항 | 💀 **사망 1명 + 중상 2명 + 경상 3명** |

### 💀 사망자 보상 산정 (자사 운전자)

| 항목 | 산정 기준 | 금액 |
|------|----------|------|
| 위자료 (사망) | 대법원 기준 | ₩80,000,000 |
| 일실수입 (40세 추정, 65세까지) | 월 ₩3,500,000 × 라이프니츠 | ₩120,000,000~150,000,000 |
| 장례비 | 실비 기준 | ₩5,000,000 |
| **사망 보상 총액** | | **₩205,000,000~235,000,000** |

### 👨‍👩‍👧‍👦 유족 배분 (4명)

| 유족 | 관계 | 나이 | 법정 상속비율 | 예상 수령 (₩2억 기준) |
|------|------|------|-------------|---------------------|
| 배우자 | 배우자 | 45세 | **3/9 (33.3%)** | ₩66,700,000 |
| 자녀1 | 자녀 | 20세 | **2/9 (22.2%)** | ₩44,400,000 |
| 자녀2 | 자녀 | 17세 | **2/9 (22.2%)** | ₩44,400,000 |
| 자녀3 | 자녀 | 14세 | **2/9 (22.2%)** | ₩44,400,000 |

> 📌 민법 제1009조: 배우자 1.5배 가산. 배우자 1.5 : 자녀 1 : 자녀 1 : 자녀 1 = 1.5:1:1:1 → 3:2:2:2

### 👨‍⚕️ 생존 피해자 5명

| 피해자 | 차량 | 등급 | 치료일수 | 유형 | 예상 합의금 |
|--------|------|------|---------|------|-----------|
| 자사 동승자1 | A | **5급** | 90일 | 중상(업무) | ₩15,000,000~20,000,000 |
| 자사 동승자2 | A | **5급** | 120일 | 중상(업무) | ₩18,000,000~25,000,000 |
| 타사 운전자 | B | 12급 | 14일 | 경상 | ₩1,800,000 |
| 타사 동승자1 | B | 12급 | 21일 | 경상 | ₩2,200,000 |
| 타사 동승자2 | B | 14급 | 7일 | 경미 | ₩800,000 |
| **합계** | | | | | **₩37,800,000~49,800,000** |

### 🚗 차량 손해

| 차량 | 수리비 | 판정 | 비고 |
|------|--------|------|------|
| A차 (스타리아) | ₩45,000,000 | **전손** | 가액 ₩55M, 수리비/가액 81.8% → 전손 기준(80%) 초과 |
| B차 (트럭) | ₩5,000,000 | 수리 | 후면부 경미 |

> 스타리아 수리비/가액 = 81.8% → 전손 기준(80%) **초과** — 전부손해 확정. A필러 변형+전면유리 파손으로 구조적 복원 불가

### 💰 보험사 부담 종합

| 구분 | 자사(A, 30%) 부담 | 타사(B, 70%) 부담 |
|------|------------------|------------------|
| 사망 보상 (₩2억) | — | ₩200,000,000 (B과실) |
| 자사 동승자 중상 (₩35~45M) | ₩10,500,000~13,500,000 | ₩24,500,000~31,500,000 |
| 타사 탑승자 경상 (₩4.8M) | ₩1,440,000 | — |
| 자사 차량 (₩55M 전손) | — | ₩38,500,000 (70%) |
| 타사 차량 (₩5M) | ₩1,500,000 | — |
| **총 부담** | **₩13,440,000~₩16,440,000** | **₩263,000,000~₩270,000,000** |

### ✅ 종합 의견
> 사망사고로 보상 규모가 매우 큼. 타사(B) 70% 과실로 사망 보상 ₩2억 + 중상자 보상 + 전손 처리가 핵심.
> 유족 4명 배분(배우자 33.3%, 자녀 각 22.2%)은 법정 상속비율 적용. 5급 중상 동승자 2명은
> 업무 동승이므로 산재보험 병행 검토 필요. 자사 부담은 30% 과실로 ₩13~16M 수준이나,
> **사망사건은 소송 전환 가능성이 높아** 예비비 확보 필요.`;

const UC9_ESTIMATE_RESPONSE = `## 🤖 AI 견적 검증 리포트 — 보험사기 패턴 탐지 (BMW 5시리즈 반복접수)

### 📋 사고 개요
| 항목 | 내용 |
|------|------|
| 자사 A차 | **BMW 5시리즈** (2023, 22,000km, 외산) |
| 타사 B차 | **현대 아반떼** (2022, 38,000km) |
| 과실 | **50% : 50%** |
| 🚨 **사기 의심 점수** | **78점 / 100점** (SIU 의뢰 기준 초과) |

### 🚨 사기 탐지 증거 (4가지 패턴)

| # | 패턴 | 세부 내용 | 위험도 |
|---|------|----------|--------|
| 1 | **6개월 내 3회 접수** | 접수 이력: ₩3.2M → ₩4.5M → ₩4.8M (현재) | 🔴 높음 |
| 2 | **동일 정비소 반복** | XX모터스 강남점 — 3회 모두 동일 정비소 | 🔴 높음 |
| 3 | **지연 병원 방문** | 사고 후 **72시간 뒤** 최초 병원 방문 | 🟡 중간 |
| 4 | **과잉 진단** | 경미 사고 대비 14급 진단 (과잉 의심) | 🟡 중간 |

### 📊 청구 금액 vs AI 적정 비교

| 항목 | 청구 금액 | AI 적정 | **차이** | 사기 의심 근거 |
|------|----------|---------|---------|--------------|
| 리어 범퍼(상) | ₩1,800,000 | ₩450,000 | **▼ ₩1,350,000** | 판금 가능 → ASSY 교체 청구 |
| 트렁크/테일게이트 | ₩1,500,000 | ₩400,000 | **▼ ₩1,100,000** | 경미 변형 → 전체 교체 청구 |
| 우 리어램프 | ₩650,000 | ₩250,000 | **▼ ₩400,000** | 크랙 없음 → 교체 청구 |
| 도장+공임 | ₩850,000 | ₩100,000 | **▼ ₩750,000** | 4면 도장 → 1면 터치업 적정 |
| **합계** | **₩4,800,000** | **₩1,200,000** | **▼ ₩3,600,000** | **과다 청구율 300%** |

### 🔍 과다 청구 상세 분석

**1. 리어 범퍼 (₩1.8M → ₩450K, ▼₩1.35M)**
- 사진 분석: 범퍼 **표면 스크래치 + 경미 변형** (깊이 3mm 이하)
- 정비소 청구: BMW 순정 범퍼 ASSY 교체 (₩1,200,000 + 공임 ₩600,000)
- AI 판단: **판금+부분도장으로 충분** — 보험개발원 경미손상 2유형 해당
- ⚠️ **이전 접수에서도 동일 부위(후면 범퍼) 교체 이력** → 반복 교체 사기 의심

**2. 트렁크 (₩1.5M → ₩400K, ▼₩1.1M)**
- 경미 접촉 사고에서 트렁크 전체 교체는 과도
- 충격량 대비 손상 범위 불일치 (B차 아반떼 전면 범퍼 하단만 접촉)

### 📈 사기 점수 산출 근거

| 요소 | 배점 | 점수 | 사유 |
|------|------|------|------|
| 접수 빈도 | 25 | **22** | 6개월 3회 (평균 2개월 1회) |
| 정비소 집중도 | 20 | **18** | 동일 정비소 100% |
| 청구/적정 비율 | 20 | **16** | 300% 과다 (₩4.8M/₩1.2M) |
| 병원 방문 지연 | 15 | **10** | 72시간 지연 |
| 부위 반복성 | 10 | **7** | 후면 범퍼 반복 |
| 기타 정황 | 10 | **5** | — |
| **합계** | **100** | **78** | SIU 의뢰 기준(70점) 초과 |

### 🏢 SIU (보험사기 특별조사) 의뢰

- 사기 점수 **78점** → SIU 의뢰 기준(70점) **초과**
- 의뢰 사항:
  1. XX모터스 강남점 3건 청구 패턴 조사
  2. A차 운전자 과거 보험 이력 전수 조회 (타사 포함)
  3. 사고 현장 CCTV/블랙박스 확보 및 충격량 분석
  4. 정비소-운전자 공모 여부 확인

### ✅ 종합 의견
> BMW 5시리즈 수리비 ₩4,800,000 청구 중 **₩3,600,000(75%)이 과다** — 적정 ₩1,200,000.
> 판금 가능한 경미 손상을 ASSY 교체로 청구하는 **전형적 보험사기 패턴**.
> 6개월 3회 접수 + 동일 정비소 + 과다 청구율 300% → 사기 점수 **78점** (SIU 기준 초과).
> **SIU 의뢰 후 조사 완료 전까지 보험금 지급 보류** 권고. 형사고발 검토 필요.`;

const UC10_ESTIMATE_RESPONSE = `## 🤖 AI 견적 검증 리포트 — 태풍 침수 전손 (제네시스 G80)
...
| 사고유형 | **태풍 침수 (자연재해)** |
| 침수 수위 | 🌊 **엔진룸 이상** (전손 특례) |
| 접수 경과 | ⚠️ **사고 후 약 6개월 경과** (시효 내) |

### 🌊 침수 전손 특례 판정

| 항목 | 기준 | 본 건 | 판정 |
|------|------|-------|------|
| 침수 수위 | 대시보드 이상 → 전손 | **엔진룸 이상** | ✅ 전손 |
| 침수 유형 | 해수 > 담수 | **해수(태풍)** | ⚠️ 해수 부식 |
| 수리 가능성 | — | ECU+배선 전손 | ❌ 수리 불가 |

> 📌 **침수 전손 특례**: 침수 차량은 수리비 산정 없이 **침수 수위가 대시보드(엔진룸) 이상이면 전손 처리** (자기차량손해 약관)
> 해수 침수 시 전자장비+배선 부식이 불가역적 → 수리비 무관하게 전손 확정
...
| 플로어패널 | 침수 | 해수 부식 진행 |
| 언더커버 | 침수 | 배수 불량 |
| 프론트/리어 서브프레임 | 침수 | 구조물 부식 개시 |
| 연료탱크/배터리팩 | 침수 | 연료계통 오염 |
| 전방 카메라/센서 | 침수 | ADAS 전손 |
| 좌/우 헤드라이트 | 침수 | 내부 결로·침수 |
| ECU/배선 | 전손 | 전자장비 복구 불가 |

### 💰 전손 정산

| 항목 | 금액 | 비고 |
|------|------|------|
| 차량가액 | ₩72,000,000 | 보험개발원 기준 |
| 잔존물 가치 (5%) | ▼ ₩3,600,000 | 해수 침수 → 잔존가치 낮음 (5%) |
| **보험금 총액** | **₩68,400,000** | 자기차량손해 (자차) |

> 해수 침수 차량은 잔존물 가치가 **일반 전손(8~10%)보다 낮은 5%** 적용
> (해수 부식으로 부품 재사용 불가)
...
| 항목 | 일자 | 비고 |
|------|------|------|
| 사고일 | 2025-08-15 | 태풍 발생일 |
| 청구일 | 2026-02-15 | 접수일 |
| **경과일수** | **184일** | |
| 소멸시효 | **3년** (상법 제662조) | 2028-08-15 만료 |
| **잔여 시효** | **약 911일** | |

> ⚠️ 사고 후 약 6개월 경과 — 시효(3년) 내이나, **조속한 처리 권고**.
> 침수 차량은 시간 경과에 따라 부식 진행 → 잔존물 가치 추가 하락 위험.
> 장기 방치 시 환경오염(배터리액 누출 등) 이슈도 발생 가능.

### 🔍 침수 차량 추가 확인 사항

1. **침수 이력 등록**: 국토교통부 자동차 침수 이력 등록 (의무)
2. **잔존물 처리**: 보험사 인수 후 폐차 or 수출 (해수 침수는 국내 재판매 불가)
3. **대차 제공**: 자차보험 대차 특약 가입 시 대차 제공 (미가입 시 미제공)
4. **감정 평가**: 침수 수위 감정서 확보 필요 (사진·동영상 증거)

### ✅ 종합 의견
> 태풍 해수 침수로 **전손 특례 적용** — 수리비 산정 없이 전손 확정.
> 차량가액 ₩72,000,000 - 잔존물 ₩3,600,000 = **보험금 ₩68,400,000**.
> 사고 후 약 6개월 경과로 시효(3년) 잔여 약 911일 — **조속 처리 필요**.
> 해수 침수 잔존물은 5%로 낮게 산정하며, 침수 이력 등록·폐차 절차 안내 필수.`;
...
const UC_PROCESS_BASELINE = {
  ...
  items:[
    ...
    {label:"B차 렌트 — 7시리즈 21일 (₩375,000/일 × 70%)",value:5512500,color:"#f97316"},
...
// ═══ CASE 4 처리방법 프리셋 (음주+무보험) ═══
const UC4_PROCESS_RESPONSE=`[{"title":"🏆 최적안: 면책 최소화 + 정부보장사업 연계","subtitle":"음주 면책 최소 적용 + 무보험 피해자 정부보장사업 연계","cost":"₩8,500,000","period":"협상 5~7일 + 정부보장 접수 14일","satisfaction":4.3,"actions":[{"icon":"🍺","label":"음주 면책","value":"면책 최소 적용 (자기부담 20%)","color":"#dc2626"},{"icon":"🏛️","label":"정부보장","value":"무보험 피해 정부보장사업 연계","color":"#2563eb"},{"icon":"💰","label":"자사 부담","value":"₩8,500,000 (면책 후 잔여)","color":"#f97316"},{"icon":"🤕","label":"대인 처리","value":"피해자 치료비 정부보장 우선","color":"#d97706"},{"icon":"⏱️","label":"처리기간","value":"5~7일 협상 + 보장사업 14일","color":"#059669"},{"icon":"📋","label":"서류","value":"음주측정·사고확인서 확보 필수","color":"#6366f1"}],"pros":["정부보장사업 연계로 자사 부담 최소화","면책 최소 적용으로 고객 이탈 방지","피해자 치료비 정부보장으로 빠른 지급","법적 리스크 최소화"],"cons":["정부보장사업 접수 14일 소요","면책 비율 분쟁 가능","음주 기록으로 향후 가입 제한"],"savingNote":"기존 대비 ₩6,200,000 절감","recommended":true},{"title":"⚡ 공격안: 면책 조항 엄격 적용","subtitle":"음주운전 면책 조항 최대 적용 + 구상권 행사","cost":"₩3,200,000","period":"협상 7~14일","satisfaction":2.8,"actions":[{"icon":"🍺","label":"면책 적용","value":"음주 면책 100% 적용 시도","color":"#dc2626"},{"icon":"⚖️","label":"구상권","value":"가해자 대상 구상권 행사","color":"#7c3aed"},{"icon":"💰","label":"자사 부담","value":"₩3,200,000 (최소)","color":"#059669"},{"icon":"📋","label":"법적 근거","value":"약관 면책조항 + 도로교통법","color":"#6366f1"},{"icon":"⚠️","label":"리스크","value":"고객 민원 + 금감원 분쟁","color":"#d97706"},{"icon":"⏱️","label":"소요","value":"7~14일 (분쟁 시 추가)","color":"#f97316"}],"pros":["자사 부담 최소 ₩3.2M","면책 조항 법적 근거 명확","구상권으로 추가 회수 가능"],"cons":["고객 강력 반발 및 민원","금감원 분쟁조정 가능성","구상권 회수율 30% 미만","보험사 이미지 하락"],"savingNote":"기존 대비 ₩11,500,000 절감 (최대)","recommended":false},{"title":"🤝 안전안: 타협적 부담금 협의","subtitle":"면책 50% 적용 + 피해자 합의 우선 + 분할 납부","cost":"₩12,000,000","period":"합의 3~5일","satisfaction":4.0,"actions":[{"icon":"🍺","label":"면책 타협","value":"면책 50% 적용 (자기부담 50%)","color":"#dc2626"},{"icon":"🤝","label":"피해자","value":"피해자 합의 우선 처리","color":"#2563eb"},{"icon":"💳","label":"분할","value":"면책금 6개월 분할 납부","color":"#059669"},{"icon":"🤕","label":"치료비","value":"피해자 치료비 선지급","color":"#d97706"},{"icon":"⏱️","label":"종결","value":"3~5일 합의 목표","color":"#f97316"},{"icon":"😊","label":"관계","value":"고객 유지 + 피해자 만족","color":"#7c3aed"}],"pros":["빠른 합의로 분쟁 방지","고객 관계 유지 (분할 납부)","피해자 조기 치료비 지급","금감원 민원 리스크 제거"],"cons":["자사 부담 ₩12M으로 높음","면책 50%는 약관 대비 관대","향후 유사 건 선례 우려"],"savingNote":"기존 대비 ₩2,700,000 절감","recommended":false},{"title":"💡 전략안: 정부보장사업 선청구 + 면책금 분할","subtitle":"피해자 정부보장 선청구 후 면책금 12개월 분할","cost":"₩6,800,000","period":"합의 3일 + 정부보장 14일","satisfaction":4.5,"actions":[{"icon":"🏛️","label":"정부보장","value":"피해자 정부보장사업 선청구","color":"#2563eb"},{"icon":"💳","label":"면책 분할","value":"면책금 ₩4.5M 12개월 분할","color":"#059669"},{"icon":"🤕","label":"치료비","value":"피해자 치료비 정부보장 선지급","color":"#d97706"},{"icon":"⚖️","label":"면책률","value":"30% 면책 적용 (타협)","color":"#7c3aed"},{"icon":"⏱️","label":"종결","value":"3일 합의 + 정부보장 14일","color":"#f97316"},{"icon":"📉","label":"절감","value":"정부보장 연계로 ₩3.5M 절감","color":"#10b981"}],"pros":["정부보장 선청구로 피해자 즉시 보상","면책금 12개월 분할로 고객 부담 최소","자사 총 부담 ₩6.8M으로 합리적","고객 유지 + 피해자 만족 동시 달성"],"cons":["정부보장 접수 14일 소요","분할 납부 관리 비용 발생","면책 30%는 약관 기준 미달 가능"],"savingNote":"기존 대비 ₩7,900,000 절감","recommended":false,"strategic":true}]`;

// ═══ CASE 5 처리방법 프리셋 (렌터카 휴차료) ═══
const UC5_PROCESS_RESPONSE=`[{"title":"🏆 최적안: 휴차료 정산 + 제휴센터","subtitle":"휴차료 적정 산정 + 제휴센터 수리로 기간 단축","cost":"₩5,800,000","period":"합의 3~5일 + 수리 7일","satisfaction":4.4,"actions":[{"icon":"🚗","label":"휴차료","value":"일 ₩120,000 × 14일 = ₩1,680,000","color":"#dc2626"},{"icon":"🏭","label":"제휴센터","value":"수리비 ₩3,200,000 (15% 절감)","color":"#2563eb"},{"icon":"⏱️","label":"수리기간","value":"제휴센터 7일 (공식 14일 대비 단축)","color":"#059669"},{"icon":"📊","label":"가동률","value":"실 가동률 78% 기준 산정","color":"#7c3aed"},{"icon":"💰","label":"총비용","value":"₩5,800,000 (수리+휴차+렌트)","color":"#f97316"},{"icon":"📋","label":"증빙","value":"렌터카 가동률 데이터 확보","color":"#6366f1"}],"pros":["휴차료 실 가동률 기준 적정 산정","제휴센터로 수리기간 7일 단축","수리기간 단축 = 휴차료 절감 연동","총 비용 합리적 수준"],"cons":["렌터카 업체 휴차료 상향 요구 가능","가동률 데이터 검증 필요","제휴센터 품질 이의 가능"],"savingNote":"기존 대비 ₩3,400,000 절감","recommended":true},{"title":"⚡ 공격안: 휴차료 최소화 (가동률 재산정)","subtitle":"실 가동률 60% 적용 + 수리기간 최소화","cost":"₩3,900,000","period":"협상 7~10일 + 수리 5일","satisfaction":3.2,"actions":[{"icon":"📊","label":"가동률","value":"실 가동률 60% 재산정 적용","color":"#7c3aed"},{"icon":"🚗","label":"휴차료","value":"일 ₩72,000 × 10일 = ₩720,000","color":"#dc2626"},{"icon":"🏭","label":"수리비","value":"₩2,800,000 (부분수리 최소)","color":"#2563eb"},{"icon":"⏱️","label":"기간","value":"수리 5일 단축 목표","color":"#059669"},{"icon":"⚠️","label":"리스크","value":"렌터카 업체 분쟁 가능","color":"#d97706"},{"icon":"📋","label":"근거","value":"렌터카 운행기록 분석","color":"#6366f1"}],"pros":["휴차료 ₩720K로 최소화","총 비용 ₩3.9M 최저","수리기간 5일 단축"],"cons":["렌터카 업체 강력 반발","가동률 60% 근거 취약 시 패소","분쟁 장기화 리스크","업계 관행과 괴리"],"savingNote":"기존 대비 ₩5,300,000 절감 (최대)","recommended":false},{"title":"🤝 안전안: 타사 요구 수용 + 빠른 종결","subtitle":"렌터카 업체 요구 대부분 수용 + 즉시 종결","cost":"₩8,200,000","period":"합의 1~2일 + 수리 14일","satisfaction":4.1,"actions":[{"icon":"🚗","label":"휴차료","value":"일 ₩150,000 × 14일 = ₩2,100,000 수용","color":"#dc2626"},{"icon":"🏢","label":"수리","value":"공식센터 ₩4,200,000 수용","color":"#2563eb"},{"icon":"⏱️","label":"종결","value":"1~2일 즉시 합의","color":"#059669"},{"icon":"🤝","label":"관계","value":"렌터카 업체 관계 유지","color":"#7c3aed"},{"icon":"💰","label":"총비용","value":"₩8,200,000 전액 수용","color":"#f97316"},{"icon":"😊","label":"만족도","value":"분쟁 없이 깔끔 종결","color":"#d97706"}],"pros":["1~2일 즉시 합의 가능","렌터카 업체 관계 유지","분쟁 비용 제로","향후 협력 관계 유지"],"cons":["총 비용 ₩8.2M으로 가장 높음","휴차료 과다 수용","공식센터 수리비 절감 없음"],"savingNote":"기존 대비 ₩1,000,000 절감","recommended":false},{"title":"💡 전략안: 미수선 + 휴차료 현금 일괄 정산","subtitle":"미수선 현금정산 + 휴차료 일괄 패키지 합의","cost":"₩4,500,000","period":"합의 2~3일","satisfaction":4.5,"actions":[{"icon":"💵","label":"미수선","value":"수리비 ₩3.8M × 75% = ₩2,850,000 현금","color":"#059669"},{"icon":"🚗","label":"휴차료","value":"₩1,650,000 일괄 정산","color":"#dc2626"},{"icon":"⏱️","label":"종결","value":"2~3일 즉시 종결","color":"#059669"},{"icon":"📦","label":"패키지","value":"수리+휴차 일괄 ₩4,500,000","color":"#7c3aed"},{"icon":"📉","label":"절감","value":"수리기간 제거 → 휴차료 최소","color":"#10b981"},{"icon":"😊","label":"만족도","value":"현금 즉시 수령 + 빠른 종결","color":"#f59e0b"}],"pros":["미수선으로 수리기간 제거 → 휴차료 최소","현금 일괄 정산으로 2~3일 종결","패키지 합의로 추가 청구 차단","총 비용 ₩4.5M 합리적"],"cons":["렌터카 업체가 실수리 요구 가능","미수선 현금이 수리비보다 낮음","차량 상태 복원 안 됨"],"savingNote":"기존 대비 ₩4,700,000 절감","recommended":false,"strategic":true}]`;

// ═══ CASE 6 처리방법 프리셋 (3중추돌) ═══
const UC6_PROCESS_RESPONSE=`[{"title":"🏆 최적안: 3자 합의 + 각사 제휴센터","subtitle":"A-B-C 3자 동시 합의 + 각사 제휴센터 수리","cost":"₩9,500,000","period":"협상 5~7일 + 수리 10~14일","satisfaction":4.4,"actions":[{"icon":"⚖️","label":"과실 배분","value":"A 70 : B 20 : C 10","color":"#7c3aed"},{"icon":"🔧","label":"A차 수리","value":"제휴센터 ₩3,800,000","color":"#dc2626"},{"icon":"🔧","label":"B차 수리","value":"제휴센터 ₩3,200,000","color":"#2563eb"},{"icon":"🔧","label":"C차 수리","value":"제휴센터 ₩2,500,000","color":"#059669"},{"icon":"🤝","label":"3자 합의","value":"동시 합의로 구상 불필요","color":"#d97706"},{"icon":"⏱️","label":"종결","value":"5~7일 일괄 합의","color":"#f97316"}],"pros":["3자 동시 합의로 구상 절차 불필요","각사 제휴센터로 수리비 15% 절감","과실 배분 명확화로 분쟁 방지","총 비용 합리적 수준"],"cons":["3사 동시 합의 조율 어려움","B차(중간차) 과실 분쟁 가능","합의 기간 5~7일 소요"],"savingNote":"기존 대비 ₩4,800,000 절감","recommended":true},{"title":"⚡ 공격안: 과실 70:20:10 엄격 적용 + 구상","subtitle":"과실 비율 엄격 적용 + 미합의 시 구상권 행사","cost":"₩7,200,000","period":"협상 10~14일 + 구상 30일","satisfaction":3.0,"actions":[{"icon":"⚖️","label":"과실 엄격","value":"A 70 : B 20 : C 10 엄격 적용","color":"#7c3aed"},{"icon":"💰","label":"자사 부담","value":"과실 비율 내 최소 부담","color":"#059669"},{"icon":"📋","label":"구상","value":"미합의 시 구상권 행사","color":"#dc2626"},{"icon":"⚠️","label":"리스크","value":"3사 분쟁 장기화","color":"#d97706"},{"icon":"⏱️","label":"소요","value":"합의 10~14일 + 구상 30일","color":"#f97316"},{"icon":"📊","label":"근거","value":"추돌사고 과실인정기준 적용","color":"#6366f1"}],"pros":["자사 부담 최소화","과실 기준 법적 근거 확보","구상으로 초과 부담 회수"],"cons":["3사 분쟁 장기화 30일+","관리 비용 증가","B차 중간차 반발 극심","고객 만족도 최저"],"savingNote":"기존 대비 ₩7,100,000 절감 (최대)","recommended":false},{"title":"🤝 안전안: B차 중간차 양보 수용","subtitle":"B차(중간차) 과실 양보하여 빠른 합의","cost":"₩11,500,000","period":"합의 2~3일 + 수리 10일","satisfaction":4.2,"actions":[{"icon":"⚖️","label":"과실 양보","value":"A 60 : B 30 : C 10 (B 양보)","color":"#7c3aed"},{"icon":"🔧","label":"수리","value":"B차 공식센터 수용","color":"#2563eb"},{"icon":"⏱️","label":"종결","value":"2~3일 즉시 합의","color":"#059669"},{"icon":"🤝","label":"관계","value":"B차 보험사 관계 유지","color":"#d97706"},{"icon":"💰","label":"총비용","value":"₩11,500,000","color":"#f97316"},{"icon":"😊","label":"만족도","value":"빠른 종결로 전체 만족","color":"#7c3aed"}],"pros":["2~3일 즉시 합의 가능","B차 보험사 관계 유지","분쟁 비용 제로","전체 고객 만족도 양호"],"cons":["B차 양보로 자사 부담 증가","공식센터 수리비 15% 높음","향후 유사 건 선례 우려"],"savingNote":"기존 대비 ₩2,800,000 절감","recommended":false},{"title":"💡 전략안: A-B 일괄 합의 + C차 분리 처리","subtitle":"A-B 선합의 후 C차 별도 처리로 효율화","cost":"₩8,200,000","period":"A-B 합의 3일 + C차 7일","satisfaction":4.6,"actions":[{"icon":"🤝","label":"A-B 합의","value":"A-B 선합의 ₩6,000,000","color":"#2563eb"},{"icon":"🔧","label":"C차 분리","value":"C차 별도 처리 ₩2,200,000","color":"#059669"},{"icon":"⏱️","label":"A-B 종결","value":"3일 내 선합의 종결","color":"#059669"},{"icon":"📋","label":"C차 협상","value":"C차 7일 별도 협상","color":"#7c3aed"},{"icon":"📉","label":"절감","value":"단계적 처리로 협상력 확보","color":"#10b981"},{"icon":"💰","label":"총비용","value":"₩8,200,000","color":"#f97316"}],"pros":["A-B 선합의로 2건 조기 종결","C차 분리로 개별 최적 협상","단계적 처리로 리스크 분산","총 비용 ₩8.2M 합리적"],"cons":["C차 합의 지연 가능","A-B 합의 내용이 C차에 영향","2단계 처리로 관리 복잡"],"savingNote":"기존 대비 ₩6,100,000 절감","recommended":false,"strategic":true}]`;

// ═══ CASE 7 처리방법 프리셋 (전손+할부) ═══
const UC7_PROCESS_RESPONSE=`[{"title":"🏆 최적안: 전손 확정 + 잔존물 경매 + 할부 정산","subtitle":"전손 즉시 확정 + 잔존물 경매 최고가 + 할부사 직접 정산","cost":"₩40,160,000","period":"전손 확정 3일 + 경매 7일","satisfaction":4.4,"actions":[{"icon":"🚗","label":"전손 확정","value":"차량가액 ₩48,000,000 확정","color":"#dc2626"},{"icon":"🔨","label":"잔존물","value":"경매 처리 ₩3,840,000 예상 (8%)","color":"#059669"},{"icon":"💳","label":"할부 정산","value":"잔여 할부금 ₩18,000,000 직접 정산","color":"#2563eb"},{"icon":"💰","label":"고객 수령","value":"₩44.16M - ₩18M = ₩26,160,000","color":"#7c3aed"},{"icon":"🚗","label":"대차","value":"동급 대차 14일 ₩1,400,000","color":"#f97316"},{"icon":"⏱️","label":"종결","value":"전손 3일 + 경매 7일","color":"#059669"}],"pros":["전손 즉시 확정으로 빠른 처리","잔존물 경매로 최고가 회수","할부사 직접 정산으로 고객 편의","고객 ₩26.16M 즉시 수령"],"cons":["차량가액 분쟁 가능","잔존물 경매가 변동 리스크","할부사 정산 절차 2~3일 소요"],"savingNote":"잔존물 경매 ₩3,840,000 회수","recommended":true},{"title":"⚡ 공격안: 차량가액 하향 협상","subtitle":"차량가액 하향 + 잔존물 보험사 직접 처리","cost":"₩37,500,000","period":"협상 7~10일 + 경매 5일","satisfaction":3.5,"actions":[{"icon":"🚗","label":"가액 하향","value":"₩48M → ₩45M (하향 시도)","color":"#dc2626"},{"icon":"📊","label":"근거","value":"보험개발원 기준가 엄격 적용","color":"#6366f1"},{"icon":"🔨","label":"잔존물","value":"보험사 직접 처리 ₩5,200,000","color":"#059669"},{"icon":"💳","label":"할부","value":"고객 자체 정산 안내","color":"#2563eb"},{"icon":"⚠️","label":"리스크","value":"고객 반발 + 금감원 민원","color":"#d97706"},{"icon":"⏱️","label":"소요","value":"7~10일 협상","color":"#f97316"}],"pros":["자사 지급액 최소화","잔존물 직접 처리로 수익 극대화","보험개발원 기준 법적 근거"],"cons":["고객 강력 반발 예상","금감원 분쟁조정 가능","차량가액 하향은 정당성 취약","할부 미정산 시 고객 신용 문제"],"savingNote":"기존 대비 ₩2,500,000 절감 (최대)","recommended":false},{"title":"🤝 안전안: 잔존물 보험사 인수","subtitle":"잔존물 보험사 인수 + 차량가액 전액 지급","cost":"₩48,000,000","period":"확정 3일 + 인수 5일","satisfaction":4.3,"actions":[{"icon":"🚗","label":"가액 전액","value":"₩48,000,000 전액 지급","color":"#dc2626"},{"icon":"🔨","label":"잔존물","value":"보험사 인수 (경매 불필요)","color":"#2563eb"},{"icon":"💳","label":"할부","value":"할부사 직접 정산 포함","color":"#059669"},{"icon":"😊","label":"고객","value":"전액 수령으로 만족도 최고","color":"#7c3aed"},{"icon":"⏱️","label":"종결","value":"3~5일 빠른 종결","color":"#059669"},{"icon":"🤝","label":"관계","value":"고객 유지 + 재가입 유도","color":"#d97706"}],"pros":["고객 만족도 최고","3~5일 최단 종결","잔존물 인수 후 자체 처리 가능","분쟁 리스크 제로"],"cons":["자사 지급액 최대 ₩48M","잔존물 인수 후 처리 비용 발생","잔존물 가치 하락 리스크"],"savingNote":"잔존물 인수 후 ₩3~5M 회수 예상","recommended":false},{"title":"💡 전략안: 전손 즉시 확정 + 대차 최소화 + 할부사 직접 정산","subtitle":"전손 당일 확정 + 대차 7일 + 할부사 원스톱 정산","cost":"₩39,360,000","period":"확정 1일 + 정산 5일","satisfaction":4.6,"actions":[{"icon":"🚗","label":"즉시 확정","value":"전손 당일 확정 처리","color":"#dc2626"},{"icon":"🚗","label":"대차 최소","value":"대차 7일로 최소화 ₩700,000","color":"#f97316"},{"icon":"💳","label":"할부 직정산","value":"할부사 직접 정산 ₩18M","color":"#2563eb"},{"icon":"🔨","label":"잔존물","value":"즉시 경매 ₩4,800,000","color":"#059669"},{"icon":"⏱️","label":"종결","value":"1일 확정 + 5일 정산","color":"#059669"},{"icon":"📉","label":"절감","value":"대차 7일 단축 ₩700K 절감","color":"#10b981"}],"pros":["전손 당일 확정으로 최단 처리","대차 7일로 렌트비 ₩700K 절감","할부사 직접 정산으로 원스톱","잔존물 즉시 경매로 빠른 회수"],"cons":["당일 확정 위해 감정 즉시 필요","잔존물 즉시 경매 시 저가 낙찰 가능","할부사 협조 지연 가능"],"savingNote":"기존 대비 ₩8,640,000 절감","recommended":false,"strategic":true}]`;

// ═══ CASE 8 처리방법 프리셋 (사망+유족) ═══
const UC8_PROCESS_RESPONSE=`[{"title":"🏆 최적안: 유족 개별 합의 + 대인Ⅱ 활용","subtitle":"유족별 개별 합의 + 대인Ⅱ 한도 최대 활용","cost":"₩185,000,000","period":"협상 14~21일","satisfaction":4.3,"actions":[{"icon":"🕊️","label":"사망 보상","value":"위자료+장례비+일실수입 산정","color":"#dc2626"},{"icon":"👨‍👩‍👧‍👦","label":"유족 합의","value":"유족 4명 개별 합의","color":"#2563eb"},{"icon":"🛡️","label":"대인Ⅱ","value":"대인Ⅱ 한도 내 처리","color":"#7c3aed"},{"icon":"💰","label":"위자료","value":"배우자 ₩30M + 자녀3 ₩20M×3","color":"#d97706"},{"icon":"📋","label":"일실수입","value":"연소득 기준 가동연한 산정","color":"#6366f1"},{"icon":"⏱️","label":"기간","value":"14~21일 개별 합의","color":"#f97316"}],"pros":["유족 개별 맞춤 합의로 분쟁 최소화","대인Ⅱ 한도 내 처리 가능","법적 기준 준수로 소송 방지","유족별 사정 반영 가능"],"cons":["개별 합의 기간 14~21일 소요","유족 간 합의금 차이 불만 가능","일실수입 산정 분쟁 가능"],"savingNote":"소송 대비 ₩35,000,000 절감","recommended":true},{"title":"⚡ 공격안: 과실 30:70 엄격 + 대인 한도 내","subtitle":"피해자 과실 30% 적용 + 대인Ⅰ·Ⅱ 한도 내 최소 지급","cost":"₩130,000,000","period":"협상 21~30일","satisfaction":2.5,"actions":[{"icon":"⚖️","label":"과실 적용","value":"피해자 과실 30% 감경","color":"#7c3aed"},{"icon":"💰","label":"보상 감경","value":"₩185M × 70% = ₩129,500,000","color":"#dc2626"},{"icon":"🛡️","label":"대인Ⅰ","value":"대인Ⅰ 한도 ₩150M 내","color":"#2563eb"},{"icon":"📋","label":"법적 근거","value":"과실상계 법리 적용","color":"#6366f1"},{"icon":"⚠️","label":"리스크","value":"유족 소송 + 언론 리스크","color":"#d97706"},{"icon":"⏱️","label":"소요","value":"21~30일 (소송 시 6개월+)","color":"#f97316"}],"pros":["자사 부담 30% 감경","과실상계 법리 근거 명확","대인Ⅰ 한도 내 처리"],"cons":["유족 강력 반발 및 소송","언론 보도 리스크","보험사 이미지 심각 훼손","소송 시 6개월+ 장기화"],"savingNote":"기존 대비 ₩55,000,000 절감 (최대)","recommended":false},{"title":"🤝 안전안: 유족 일괄 패키지 + 위로금","subtitle":"유족 일괄 패키지 합의 + 특별 위로금 지급","cost":"₩210,000,000","period":"합의 7~10일","satisfaction":4.5,"actions":[{"icon":"🕊️","label":"일괄 패키지","value":"유족 전원 패키지 합의","color":"#dc2626"},{"icon":"💐","label":"위로금","value":"특별 위로금 ₩25,000,000","color":"#7c3aed"},{"icon":"👨‍👩‍👧‍👦","label":"유족","value":"4명 일괄 ₩185,000,000","color":"#2563eb"},{"icon":"🏥","label":"치료비","value":"부상자 치료비 전액 지원","color":"#d97706"},{"icon":"⏱️","label":"종결","value":"7~10일 일괄 합의","color":"#059669"},{"icon":"🤝","label":"관계","value":"유족 관계 최대한 배려","color":"#f59e0b"}],"pros":["7~10일 빠른 일괄 합의","유족 만족도 최고","소송 리스크 완전 제거","보험사 이미지 보호"],"cons":["총 비용 ₩210M 최고","특별 위로금 ₩25M 추가","향후 유사 건 선례 부담"],"savingNote":"소송 방지로 시간·비용 절감","recommended":false},{"title":"💡 전략안: 유족 대표 1인 협상 + 단계별 합의","subtitle":"유족 대표 선임 → 사망 합의 → 중상 → 경상 순차 처리","cost":"₩175,000,000","period":"대표 선임 3일 + 합의 10일","satisfaction":4.6,"actions":[{"icon":"👤","label":"대표 선임","value":"유족 대표 1인 협상 창구","color":"#2563eb"},{"icon":"🕊️","label":"사망 합의","value":"1단계: 사망 보상 ₩140,000,000","color":"#dc2626"},{"icon":"🤕","label":"중상 합의","value":"2단계: 중상자 ₩25,000,000","color":"#d97706"},{"icon":"💊","label":"경상 합의","value":"3단계: 경상자 ₩10,000,000","color":"#059669"},{"icon":"⏱️","label":"종결","value":"대표 3일 + 단계별 10일","color":"#f97316"},{"icon":"📉","label":"절감","value":"단계별로 합리적 금액 도출","color":"#10b981"}],"pros":["유족 대표 1인으로 협상 효율화","단계별 합의로 각 건 최적 금액","총 비용 ₩175M으로 합리적","사망→중상→경상 순서로 리스크 관리"],"cons":["유족 대표 선임 합의 필요","단계별 처리로 총 기간 13일","중간 단계에서 합의 결렬 가능"],"savingNote":"기존 대비 ₩10,000,000 절감","recommended":false,"strategic":true}]`;

// ═══ CASE 9 처리방법 프리셋 (보험사기) ═══
const UC9_PROCESS_RESPONSE=`[{"title":"🏆 최적안: SIU 조사 후 적정가 합의","subtitle":"SIU 정밀 조사 완료 후 적정 수리비로 합의","cost":"₩1,200,000","period":"SIU 조사 7~14일 + 합의 3일","satisfaction":4.2,"actions":[{"icon":"🔍","label":"SIU 조사","value":"특별조사팀 정밀 조사","color":"#dc2626"},{"icon":"📋","label":"증거 확보","value":"CCTV·블랙박스·정비이력 분석","color":"#6366f1"},{"icon":"💰","label":"적정가","value":"₩4,800,000 → ₩1,200,000 적정화","color":"#059669"},{"icon":"🔧","label":"수리 검증","value":"실제 파손 부위만 인정","color":"#2563eb"},{"icon":"⚠️","label":"사기 기록","value":"보험사기 의심 이력 등록","color":"#d97706"},{"icon":"⏱️","label":"기간","value":"SIU 7~14일 + 합의 3일","color":"#f97316"}],"pros":["SIU 조사로 과다청구 ₩3.6M 삭감 (75% 과다)","적정가 합의로 법적 리스크 최소","사기 이력 등록으로 재발 방지","증거 기반 합리적 처리"],"cons":["SIU 조사 7~14일 소요","상대방 불만 및 민원 가능","조사 비용 발생"],"savingNote":"과다청구 ₩3,600,000 삭감 (75% 과다)","recommended":true},{"title":"⚡ 공격안: 사기 혐의 통보 + 지급 보류","subtitle":"보험사기 혐의 정식 통보 + 보험금 지급 전면 보류","cost":"₩0","period":"통보 즉시 + 수사 30~90일","satisfaction":2.0,"actions":[{"icon":"🚨","label":"사기 통보","value":"보험사기 혐의 정식 통보","color":"#dc2626"},{"icon":"🚫","label":"지급 보류","value":"보험금 전액 지급 보류","color":"#7c3aed"},{"icon":"📋","label":"수사 의뢰","value":"보험사기 수사 의뢰","color":"#6366f1"},{"icon":"⚖️","label":"법적 조치","value":"형사 고발 검토","color":"#2563eb"},{"icon":"⚠️","label":"리스크","value":"무혐의 시 역소송 + 지연이자","color":"#d97706"},{"icon":"⏱️","label":"소요","value":"수사 30~90일 장기화","color":"#f97316"}],"pros":["보험금 지급 ₩0 (최대 절감)","사기범 처벌로 재발 방지","업계 사기 억제 효과"],"cons":["무혐의 시 역소송 리스크","지연이자 발생 (연 5~12%)","수사 30~90일 장기화","금감원 민원 리스크"],"savingNote":"전액 지급 보류 (₩4,800,000)","recommended":false},{"title":"🤝 안전안: 적정가로 조기 합의 (사기 불문)","subtitle":"사기 여부 불문하고 적정가로 빠르게 합의 종결","cost":"₩2,400,000","period":"합의 3~5일","satisfaction":3.8,"actions":[{"icon":"💰","label":"적정가","value":"₩4.8M → ₩2,400,000 조정","color":"#059669"},{"icon":"🤝","label":"합의","value":"사기 불문 빠른 합의","color":"#2563eb"},{"icon":"⏱️","label":"종결","value":"3~5일 즉시 종결","color":"#059669"},{"icon":"📋","label":"기록","value":"내부 사기 의심 기록만","color":"#6366f1"},{"icon":"😊","label":"관계","value":"분쟁 없이 종결","color":"#7c3aed"},{"icon":"⚠️","label":"한계","value":"사기 재발 방지 효과 없음","color":"#d97706"}],"pros":["3~5일 빠른 종결","분쟁 비용 제로","금감원 민원 리스크 없음","적정가 수준 합의"],"cons":["사기범에게 관대한 처리","₩2.4M 지급 (과다 가능)","재발 방지 효과 없음","내부 감사 지적 가능"],"savingNote":"기존 대비 ₩2,400,000 절감","recommended":false},{"title":"💡 전략안: 부분 인정(판금분만) + 교체 청구 거부 + 사기 기록","subtitle":"판금 수리만 인정 + 부품 교체 청구 전면 거부 + 사기 DB 등록","cost":"₩1,200,000","period":"통보 3일 + 합의 5일","satisfaction":4.4,"actions":[{"icon":"🔧","label":"판금만 인정","value":"판금 수리 ₩1,200,000만 인정","color":"#2563eb"},{"icon":"🚫","label":"교체 거부","value":"부품 교체 ₩3,600,000 거부","color":"#dc2626"},{"icon":"📋","label":"사기 DB","value":"보험사기 의심 DB 등록","color":"#7c3aed"},{"icon":"📊","label":"근거","value":"SIU 조사 결과 + 정비 감정","color":"#6366f1"},{"icon":"⏱️","label":"종결","value":"통보 3일 + 합의 5일","color":"#059669"},{"icon":"📉","label":"절감","value":"교체→판금 전환 ₩3.6M 절감","color":"#10b981"}],"pros":["판금만 인정으로 ₩3.6M 절감","사기 DB 등록으로 재발 방지","SIU 근거로 법적 정당성 확보","8일 내 종결 가능"],"cons":["상대방 강력 반발 예상","부분 인정 합의 거부 가능","금감원 민원 가능성","판금 품질 이의제기"],"savingNote":"기존 대비 ₩3,600,000 절감","recommended":false,"strategic":true}]`;

// ═══ CASE 10 처리방법 프리셋 (침수+시효) ═══
const UC10_PROCESS_RESPONSE=`[{"title":"🏆 최적안: 침수 전손 즉시 확정 + 시효 내 처리","subtitle":"침수 전손 즉시 확정 + 잔존물 경매 + 시효 내 완료 (수리비 무관 전손 특례)","cost":"₩60,480,000","period":"전손 확정 2일 + 경매 7일","satisfaction":4.4,"actions":[{"icon":"🌊","label":"침수 전손","value":"침수 전손 즉시 확정 (수리비 무관)","color":"#dc2626"},{"icon":"🚗","label":"차량가액","value":"₩72,000,000 (시가 기준)","color":"#2563eb"},{"icon":"🔨","label":"잔존물","value":"경매 처리 ₩5,760,000 (8%)","color":"#059669"},{"icon":"⏰","label":"시효","value":"소멸시효 내 처리 완료","color":"#7c3aed"},{"icon":"💰","label":"지급액","value":"₩72M - ₩5.76M = ₩66,240,000","color":"#f97316"},{"icon":"⏱️","label":"기간","value":"전손 2일 + 경매 7일","color":"#059669"}],"pros":["침수 전손 특례 적용 — 수리비와 무관하게 전손","잔존물 경매로 ₩5.76M 회수","시효 내 처리로 법적 리스크 제거","고객 빠른 보상 수령"],"cons":["차량가액 분쟁 가능","잔존물 침수차 경매가 저조","시효 임박 시 협상력 저하"],"savingNote":"잔존물 경매 ₩5,760,000 회수","recommended":true},{"title":"⚡ 공격안: 잔존물 가치 극대화","subtitle":"잔존물 부품별 분리 매각 + 차량가액 엄격 산정","cost":"₩54,000,000","period":"감정 5일 + 분리매각 14일","satisfaction":3.3,"actions":[{"icon":"🔨","label":"분리매각","value":"잔존물 부품별 분리 ₩8,500,000","color":"#059669"},{"icon":"📊","label":"가액 산정","value":"₩72M → ₩68M (감가 적용)","color":"#dc2626"},{"icon":"🔧","label":"부품","value":"엔진·미션·전장 개별 매각","color":"#2563eb"},{"icon":"📋","label":"감정","value":"침수 등급별 부품 감정","color":"#6366f1"},{"icon":"⚠️","label":"리스크","value":"고객 반발 + 시효 압박","color":"#d97706"},{"icon":"⏱️","label":"소요","value":"감정 5일 + 분리 14일","color":"#f97316"}],"pros":["잔존물 ₩8.5M 최대 회수","차량가액 감가로 ₩4M 절감","부품별 개별 매각 수익"],"cons":["분리매각 14일 추가 소요","시효 압박으로 시간 부족 가능","고객 반발 (가액 하향)","침수 부품 매각 수요 불확실"],"savingNote":"기존 대비 ₩6,240,000 절감 (최대)","recommended":false},{"title":"🤝 안전안: 시가 감가 최소 적용","subtitle":"차량가액 시가 기준 + 감가 최소 적용 + 잔존물 인수","cost":"₩72,000,000","period":"확정 2일 + 인수 3일","satisfaction":4.3,"actions":[{"icon":"🚗","label":"시가 기준","value":"₩72,000,000 전액 인정","color":"#dc2626"},{"icon":"📉","label":"감가 최소","value":"감가 미적용 (고객 배려)","color":"#2563eb"},{"icon":"🔨","label":"잔존물","value":"보험사 인수 처리","color":"#059669"},{"icon":"⏰","label":"시효","value":"시효 내 즉시 처리","color":"#7c3aed"},{"icon":"⏱️","label":"종결","value":"2~3일 최단 종결","color":"#059669"},{"icon":"😊","label":"고객","value":"전액 보상으로 만족도 최고","color":"#f59e0b"}],"pros":["고객 만족도 최고","2~3일 최단 종결","시효 리스크 완전 제거","분쟁 비용 제로"],"cons":["자사 지급액 최대 ₩72M","잔존물 인수 후 처리 비용","감가 미적용으로 과다 지급"],"savingNote":"잔존물 인수 후 ₩4~7M 회수 예상","recommended":false},{"title":"💡 전략안: 침수 전손 특례 + 잔존물 직접 처리 + 대차 미제공","subtitle":"침수 전손 특례 적용 + 잔존물 직접 경매 + 대차 미제공","cost":"₩58,240,000","period":"확정 1일 + 경매 5일","satisfaction":4.5,"actions":[{"icon":"🌊","label":"침수 전손","value":"침수 전손 특례 ₩72M 적용","color":"#2563eb"},{"icon":"🔨","label":"직접 처리","value":"잔존물 직접 경매 ₩7,200,000","color":"#059669"},{"icon":"🚫","label":"대차 미제공","value":"전손 확정 → 대차 미제공","color":"#dc2626"},{"icon":"⏰","label":"시효","value":"1일 즉시 확정 (시효 확보)","color":"#7c3aed"},{"icon":"📉","label":"절감","value":"대차비 ₩1.4M + 잔존물 ₩7.2M","color":"#10b981"},{"icon":"⏱️","label":"종결","value":"1일 확정 + 5일 경매","color":"#059669"}],"pros":["침수 전손 특례 적용으로 수리비 무관 전손","잔존물 직접 경매로 ₩7.2M 회수","대차 미제공으로 ₩1.4M 절감","1일 즉시 확정으로 시효 확보"],"cons":["대차 미제공 시 고객 불만","잔존물 침수차 경매가 변동","침수 특약 미가입 시 적용 불가"],"savingNote":"기존 대비 ₩13,760,000 절감","recommended":false,"strategic":true}]`;
...
const ONTOLOGY = {
  ...
  rules: [
    ...
    {id:"R18",name:"잔존물 가치 산정",cat:"견적",priority:2,
      ...
      then:(ctx)=>{const rate=ctx.isFlood&&ctx.floodType?.includes("해수")?0.05:0.08;const salvage=Math.round((ctx.vehicleValue||0)*rate);return{flag:"잔존물_산정",msg:`전부손해 확정 → 잔존물 가치 ₩${salvage.toLocaleString()} (가액의 ~${Math.round(rate*100)}%${ctx.isFlood?" — 해수침수 잔존가치 저감":""}). 보상금 = 가액 ₩${(ctx.vehicleValue||0).toLocaleString()} - 잔존물 = ₩${((ctx.vehicleValue||0)-salvage).toLocaleString()}`,clause:"보통약관 제24조",severity:"warning"};}},
...
function buildContextFromCase(useCase,extraData={}){
  const base={
    ...
    uc6:{accidentType:"3중 추돌 (A→B→C)",vehicleA:"현대 그랜저",vehicleB:"기아 K8",
      ...
      repairCostA:8500000,repairCostB:14200000,repairCostC:4500000,totalCostB:14200000,
      vehicleValue:45000000,vehicleAge:2,injuryGrade:10,treatDays:28,
      claimants:4,selfDamage:true,damageAmount:8500000,multiVehicle:true,vehicleCount:3,
      ...
      costFlows:{AtoB:7952000,AtoC:3150000,BtoA:1700000,BtoC:900000,CtoA:850000,CtoB:1420000},
      totalLoss:false,certifiedParts:false,minorDamage:false,partsCost:14200000,
      dui:false,unlicensed:false,majorFault:false,claimFiled:true},
    ...
    uc8:{accidentType:"고속도로 다중 충돌 사망사고",vehicleA:"현대 스타리아(9인승)",vehicleB:"대형 트럭",
      ...
      repairCostA:45000000,repairCostB:5000000,totalCostB:5000000,
      vehicleValue:55000000,vehicleAge:1,injuryGrade:1,treatDays:0,
      claimants:6,selfDamage:true,damageAmount:45000000,
    ...
    uc9:{accidentType:"반복 접수 사기 의심",vehicleA:"BMW 5시리즈",vehicleB:"현대 아반떼",
      ...
      repairCostA:4800000,repairCostB:2800000,totalCostB:2800000,
      vehicleValue:52000000,vehicleAge:2,injuryGrade:14,treatDays:35,
      claimants:2,selfDamage:true,damageAmount:4800000,
      fraudScore:78,
      fraudEvidence:{
        ...
        previousClaimAmounts:[3200000,4500000,4800000],
      ...
      totalLoss:false,certifiedParts:false,minorDamage:false,partsCost:4800000,
      dui:false,unlicensed:false,majorFault:false,claimFiled:true},
    uc10:{accidentType:"태풍 침수 (자연재해)",vehicleA:"제네시스 G80",vehicleB:"자연재해(태풍)",
      ...
      accidentDate:"2025-08-15",claimDate:"2026-02-15",
      daysSinceAccident:184,
      totalLoss:true,certifiedParts:false,minorDamage:false,partsCost:0,
      dui:false,unlicensed:false,majorFault:false,claimFiled:true},
  };
...
function generateFallback(s,m){
  ...
  if(s.includes("처리방법")||s.includes("처리 방법"))return`[{"title":"미수선 처리","subtitle":"현금정산(협의금)","cost":"₩1,400,000","period":"3~5일","satisfaction":3.8,"pros":["빠른 종결","고객 자유도 높음"],"cons":["수리 미보장","감가 우려"],"recommended":false},{"title":"제휴 서비스 센터","subtitle":"보험사 협력정비망","cost":"₩1,700,000","period":"5~7일","satisfaction":4.2,"pros":["비용 절감 15%","품질 보증","대차 지원"],"cons":["일부 대체부품 사용"],"recommended":true},{"title":"공식 서비스 센터","subtitle":"제조사 공식 AS","cost":"₩2,000,000","period":"7~14일","satisfaction":4.7,"pros":["OEM 순정부품","최고 품질","보증 유지"],"cons":["비용 최대","대기 시간 길음"],"recommended":false,"strategic":true}]`;
...
const DAMAGE_CONFIGS = {
  ...
  uc4_a: { vehicle:"기아 K5", badge:"자사 A차", badgeColor:"#2563eb", totalCost:"₩8,500,000",
    parts:[
  ...
  uc4_b: { vehicle:"현대 투싼", badge:"타사 B차", badgeColor:"#dc2626", totalCost:"₩4,200,000",
    parts:[
  ...
  uc5_a: { vehicle:"현대 쏘나타 (렌터카)", badge:"자사 A차", badgeColor:"#2563eb", totalCost:"₩3,200,000",
    parts:[
  ...
  uc5_b: { vehicle:"기아 스포티지", badge:"타사 B차", badgeColor:"#dc2626", totalCost:"₩1,800,000",
    parts:[
  ...
  uc6_c: { vehicle:"기아 스포티지 (후미차)", badge:"타사 C차", badgeColor:"#f97316", totalCost:"₩4,500,000",
    parts:[
  ...
  uc7_a: { vehicle:"기아 모하비", badge:"자사 A차", badgeColor:"#2563eb", totalCost:"₩전손 (시가 ₩48,000,000)",
    parts:[
      ...
      {id:"pillarC",label:"좌 C필러",severity:"변형 전손",cost:"₩1,200,000",x:55,y:55,w:12,h:45,phase:9,color:"#dc2626"},
      {id:"wheelFL",label:"좌 전륜 휠/타이어",severity:"파손",cost:"₩800,000",x:48,y:178,w:18,h:18,phase:10,color:"#dc2626"},
      {id:"wheelRL",label:"좌 후륜 휠/타이어",severity:"파손",cost:"₩800,000",x:48,y:28,w:18,h:18,phase:11,color:"#dc2626"},
    ]},
  ...
  uc8_b: { vehicle:"대형 카고트럭", badge:"타사 B차", badgeColor:"#dc2626", totalCost:"₩5,000,000",
    parts:[
...
function Tab1({activeCase,setActiveCase,flow,onNext}){
  ...
  const CASE_CARS={
    ...
    uc6:{
      ...
      c:{origin:"국산",mk:"기아",md:"스포티지",yr:"2022",ml:"35000",
...
위 정보를 기반으로 파손 부위와 정도를 추정하여 JSON으로 응답하세요.`;
  ...
  const calc=async()=>{if(!mk||!md||!sp.length)return;sLd(true);sRs(null);sAt("");setOntoResult(null);
    ...
    const CASE_SCENARIOS={
      ...
      uc8:{accident:"고속도로에서 자사 현대 스타리아(9인승)가 야간 무등화 정차 중인 대형 트럭 후미에 추돌. 탑승자 1명 사망",opponent:"대형 카고트럭 (야간 비상등 미점등 · 갓길 미진입, 후면 경미 손상)",issue:"사망사고 → 유족 4명(배우자+자녀3)에게 대인Ⅰ 사망한도 ₩2억 분배. 6명 피해자(사망1+중상2+경상3) 개별 처리. 트럭 과실 70% (야간 무등화+갓길 미진입)",focus:"유족 분배 순위(배우자>자녀), 6명 개별 상해등급 한도 조회, 전손(차량가액 ₩55M, 수리비/가액 81.8%) 처리, 사망위자료 ₩8,000만"},
      ...
      uc10:{accident:"태풍으로 자사 제네시스 G80이 엔진룸 이상 수위까지 침수. 자연재해 단독",opponent:"자연재해(태풍) — 과실 없음",issue:"침수 전손 특례 적용 (수리비와 무관하게 전손). 사고 후 약 6개월 경과 → 청구 시효 3년 내 조속 처리 필요",focus:"침수 전손 보상 = 차량가액 ₩72M - 잔존물, 해수 침수로 전자장비 전량 전손, 하부 구조 부식, 침수 특약 가입 여부 확인"},
    };
...
4. **종합 의견 및 추천** — 최적 처리 방안 (예상 총비용 포함)`;
    const ESTIMATE_RESPONSES={uc1:UC1_ESTIMATE_RESPONSE,uc2:UC_ESTIMATE_RESPONSE,uc3:UC3_ESTIMATE_RESPONSE,uc4:UC4_ESTIMATE_RESPONSE,uc5:UC5_ESTIMATE_RESPONSE,uc6:UC6_ESTIMATE_RESPONSE,uc7:UC7_ESTIMATE_RESPONSE,uc8:UC8_ESTIMATE_RESPONSE,uc9:UC9_ESTIMATE_RESPONSE,uc10:UC10_ESTIMATE_RESPONSE};
    const a=ESTIMATE_RESPONSES[useCase]||await callAI(detailedPrompt,detailedMsg);
    sAt(a);sLd(false);
  };
      ...
      <div style={{overflowY:"auto"}}>{!rs&&!ld&&<Em text="차량과 파손 부위 선택 후 실행하세요"/>}
        {rs&&<div style={{animation:"fadeIn .4s"}}>
          ...
          <div style={{...CD,border:"1px solid #a5f3fc"}}><div style={{display:"flex",alignItems:"center",gap:7,marginBottom:9}}>
            ...
            {/* Vehicle Tab Selector for all cases */}
            {useCase&&at&&<div style={{display:"flex",gap:0,marginBottom:12,background:"#f1f5f9",borderRadius:10,padding:3}}>
              {(({uc1:[{l:"🚙 타사 (BMW 7시리즈)",sub:"₩25M 청구 검증"},{l:"🚗 자사 (그랜저)",sub:"₩5M 수리비"},{l:"📊 보험사 총 지출",sub:"시나리오 비교"}],
                uc2:[{l:"🚙 타사 (GV80)",sub:"₩10M 청구 검증"},{l:"🚗 자사 (그랜저)",sub:"수리비+렌트+자차"},{l:"📊 보험사 총 지출",sub:"합산 비용 비교"}],
                uc3:[{l:"🚙 타사 (BMW 5시리즈)",sub:"₩1.2M 검증"},{l:"🚗 자사 (그랜저)",sub:"₩1.5M 수리비"},{l:"📊 총 지출",sub:"85:15 시나리오"}],
                uc4:[{l:"🚗 자사 (K5)",sub:"음주면책 ₩8.5M"},{l:"🚙 타사 (투싼)",sub:"무보험 ₩4.2M"},{l:"📊 총 부담",sub:"면책 정리"}],
                uc5:[{l:"🚗 자사 (쏘나타)",sub:"렌터카 ₩3.2M"},{l:"🚕 휴차료",sub:"영업손실 산정"},{l:"📊 청구 총액",sub:"타사 회수"}],
                uc6:[{l:"🚗 3대 차량",sub:"A→B→C 파손"},{l:"🔄 비용 흐름",sub:"6방향 배분"},{l:"📊 순부담",sub:"3사 정산"}],
                uc7:[{l:"🚗 자사 (모하비)",sub:"전손 ₩48M"},{l:"🏗️ 시설물",sub:"가드레일 배상"},{l:"📊 전손 정산",sub:"할부 우선변제"}],
                uc8:[{l:"💀 사망 보상",sub:"유족 4명 배분"},{l:"👨‍⚕️ 피해자 6명",sub:"중상+경상"},{l:"📊 보험사 부담",sub:"30:70 배분"}],
                uc9:[{l:"🚨 사기 탐지",sub:"점수 78점"},{l:"📊 청구 vs 적정",sub:"₩4.8M→₩1.2M"},{l:"🏢 SIU 의뢰",sub:"조사 항목"}],
                uc10:[{l:"🚗 자사 (G80)",sub:"침수 전손 ₩72M"},{l:"🌊 침수 분석",sub:"전손 특례"},{l:"📊 보상 정산",sub:"시효 관리"}],
              })[useCase]||[{l:"📋 분석 리포트",sub:"AI 검증"},{l:"🔍 상세 분석",sub:"추가 정보"},{l:"📊 종합",sub:"시나리오"}]).map((t,i)=>
            ...
            <div style={{fontSize:12.5}}>{useCase==="uc1"&&vehTab===1?<RT text={UC1_ESTIMATE_SELF}/>:useCase==="uc1"&&vehTab===2?<RT text={UC1_ESTIMATE_TOTAL}/>:useCase==="uc2"&&vehTab===1?<RT text={UC_ESTIMATE_SELF}/>:useCase==="uc2"&&vehTab===2?<RT text={UC_ESTIMATE_TOTAL}/>:useCase==="uc3"&&vehTab===1?<RT text={UC3_ESTIMATE_SELF}/>:useCase==="uc3"&&vehTab===2?<RT text={UC3_ESTIMATE_TOTAL}/>:<RT text={tA}/>}</div>
            {/* ═══ 온톨로지 추론 체인 ═══ */}
            ...
            {useCase&&vehTab===2&&<div style={{display:"flex",flex:"column",gap:8,marginTop:14}}>
...
핵심쟁점: ${sc?.sections?.[1]?.items?.[0]||""}`);
  ...
  const runAnalysis=async()=>{setStage("loading");setSummary(null);setProposals(null);setSelIdx(null);setDetText("");setSumText("");setOntoResult3(null);
    ...
    const PROCESS_RESPONSES={uc1:UC_PROCESS_RESPONSE,uc2:UC2_PROCESS_RESPONSE,uc3:UC3_PROCESS_RESPONSE,uc4:UC4_PROCESS_RESPONSE,uc5:UC5_PROCESS_RESPONSE,uc6:UC6_PROCESS_RESPONSE,uc7:UC7_PROCESS_RESPONSE,uc8:UC8_PROCESS_RESPONSE,uc9:UC9_PROCESS_RESPONSE,uc10:UC10_PROCESS_RESPONSE};
    const pR=PROCESS_RESPONSES[useCase]||await callAI("손해사정 전문 AI. 3가지 처리방법 JSON배열만:\n[{\"title\":\"\",\"subtitle\":\"\",\"cost\":\"금액\",\"period\":\"기간\",\"satisfaction\":4.5,\"pros\":[],\"cons\":[],\"recommended\":false}]\n순서:(1)미수선(2)제휴(3)공식",fullInput);
    ...
    // 추천 적용 + 정렬 (AI추천 → 전략추천 → 나머지)
    pA[rec.idx].recommended=true;pA[rec.idx].recReason=rec.reason;
    pA.sort((a,b)=>{if(a.recommended&&!b.recommended)return -1;if(!a.recommended&&b.recommended)return 1;if(a.strategic&&!b.strategic)return -1;if(!a.strategic&&b.strategic)return 1;return 0;});
    setProposals(pA);
    setIntakeProg({step:steps.length,total:steps.length,msg:"✅ 분석 완료!",pct:100});
    await new Promise(r=>setTimeout(r,400));
  ...
  const CI=[IC.cs,IC.wr,IC.sh,"💡"],CC=["#0891b2","#7c3aed","#2563eb","#059669"],CB=["#ecfeff","#f5f3ff","#eff6ff","#ecfdf5"],CR=["#a5f3fc","#c4b5fd","#bfdbfe","#86efac"];
      ...
      {stage==="result"&&summary&&<div style={{flex:1,overflowY:"auto",display:"flex",flexDirection:"column",gap:12}}>
        ...
        {proposals&&<div style={{animation:"fadeIn .5s"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:12}}>
            {proposals.map((p,idx)=><div key={idx} onClick={()=>showDet(idx)} style={{background:CB[idx%CB.length],borderRadius:15,padding:"16px 14px",border:`2px solid ${(p.recommended||p.strategic)?CC[idx%CC.length]:CR[idx%CR.length]}`,cursor:"pointer",transition:"all .2s",position:"relative",boxShadow:(p.recommended||p.strategic)?`0 4px 16px ${CC[idx%CC.length]}20`:"none",display:"flex",flexDirection:"column"}}
              onMouseEnter={e=>{e.currentTarget.style.transform="translateY(-3px)";e.currentTarget.style.boxShadow=`0 8px 24px ${CC[idx%CC.length]}12`;e.currentTarget.style.borderColor=CC[idx%CC.length]}}
              onMouseLeave={e=>{e.currentTarget.style.transform="none";e.currentTarget.style.boxShadow=(p.recommended||p.strategic)?`0 4px 16px ${CC[idx%CC.length]}20`:"none";e.currentTarget.style.borderColor=(p.recommended||p.strategic)?CC[idx%CC.length]:CR[idx%CR.length]}}>
              ...
              {!p.recommended&&p.strategic&&<div style={{position:"absolute",top:9,right:9,background:"linear-gradient(135deg,#7c3aed,#6366f1)",color:"#fff",padding:"2px 8px",borderRadius:10,fontSize:9.5,fontWeight:700}}>💡 전략 추천</div>}
