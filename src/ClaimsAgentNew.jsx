...
const UC7_PROCESS_RESPONSE=`[{"title":"🏆 최적안: 전손 확정 + 잔존물 경매 + 할부 정산","subtitle":"전손 즉시 확정 + 잔존물 경매 최고가 + 할부사 직접 정산","cost":"₩28,000,000","period":"전손 확정 3일 + 경매 7일","satisfaction":4.4,"actions":[{"icon":"🚗","label":"전손 확정","value":"차량가액 ₩32,000,000 확정","color":"#dc2626"},{"icon":"🔨","label":"잔존물","value":"경매 처리 ₩4,500,000 예상","color":"#059669"},{"icon":"💳","label":"할부 정산","value":"잔여 할부금 ₩18,000,000 직접 정산","color":"#2563eb"},{"icon":"💰","label":"고객 수령","value":"₩32M - ₩18M = ₩14,000,000","color":"#7c3aed"},{"icon":"🚗","label":"대차","value":"동급 대차 14일 ₩1,400,000","color":"#f97316"},{"icon":"⏱️","label":"종결","value":"전손 3일 + 경매 7일","color":"#059669"}],"pros":["전손 즉시 확정으로 빠른 처리","잔존물 경매로 최고가 회수","할부사 직접 정산으로 고객 편의","고객 ₩14M 즉시 수령"],"cons":["차량가액 분쟁 가능","잔존물 경매가 변동 리스크","할부사 정산 절차 2~3일 소요"],"savingNote":"잔존물 경매 ₩4,500,000 회수","recommended":true},{"title":"⚡ 공격안: 차량가액 상향 협상","subtitle":"차량가액 상향 + 잔존물 보험사 직접 처리","cost":"₩25,500,000","period":"협상 7~10일 + 경매 5일","satisfaction":3.5,"actions":[{"icon":"🚗","label":"가액 상향","value":"₩32M → ₩30M (하향 시도)","color":"#dc2626"},{"icon":"📊","label":"근거","value":"보험개발원 기준가 엄격 적용","color":"#6366f1"},{"icon":"🔨","label":"잔존물","value":"보험사 직접 처리 ₩5,200,000","color":"#059669"},{"icon":"💳","label":"할부","value":"고객 자체 정산 안내","color":"#2563eb"},{"icon":"⚠️","label":"리스크","value":"고객 반발 + 금감원 민원","color":"#d97706"},{"icon":"⏱️","label":"소요","value":"7~10일 협상","color":"#f97316"}],"pros":["자사 지급액 최소화","잔존물 직접 처리로 수익 극대화","보험개발원 기준 법적 근거"],"cons":["고객 강력 반발 예상","금감원 분쟁조정 가능","차량가액 하향은 정당성 취약","할부 미정산 시 고객 신용 문제"],"savingNote":"기존 대비 ₩2,500,000 절감 (최대)","recommended":false},{"title":"🤝 안전안: 잔존물 보험사 인수","subtitle":"잔존물 보험사 인수 + 차량가액 전액 지급","cost":"₩32,000,000","period":"확정 3일 + 인수 5일","satisfaction":4.3,"actions":[{"icon":"🚗","label":"가액 전액","value":"₩32,000,000 전액 지급","color":"#dc2626"},{"icon":"🔨","label":"잔존물","value":"보험사 인수 (경매 불필요)","color":"#2563eb"},{"icon":"💳","label":"할부","value":"할부사 직접 정산 포함","color":"#059669"},{"icon":"😊","label":"고객","value":"전액 수령으로 만족도 최고","color":"#7c3aed"},{"icon":"⏱️","label":"종결","value":"3~5일 빠른 종결","color":"#059669"},{"icon":"🤝","label":"관계","value":"고객 유지 + 재가입 유도","color":"#d97706"}],"pros":["고객 만족도 최고","3~5일 최단 종결","잔존물 인수 후 자체 처리 가능","분쟁 리스크 제로"],"cons":["자사 지급액 최대 ₩32M","잔존물 인수 후 처리 비용 발생","잔존물 가치 하락 리스크"],"savingNote":"잔존물 인수 후 ₩3~5M 회수 예상","recommended":false},{"title":"💡 전략안: 전손 즉시 확정 + 대차 최소화 + 할부사 직접 정산","subtitle":"전손 당일 확정 + 대차 7일 + 할부사 원스톱 정산","cost":"₩26,800,000","period":"확정 1일 + 정산 5일","satisfaction":4.6,"actions":[{"icon":"🚗","label":"즉시 확정","value":"전손 당일 확정 처리","color":"#dc2626"},{"icon":"🚗","label":"대차 최소","value":"대차 7일로 최소화 ₩700,000","color":"#f97316"},{"icon":"💳","label":"할부 직정산","value":"할부사 직접 정산 ₩18M","color":"#2563eb"},{"icon":"🔨","label":"잔존물","value":"즉시 경매 ₩4,800,000","color":"#059669"},{"icon":"⏱️","label":"종결","value":"1일 확정 + 5일 정산","color":"#059669"},{"icon":"📉","label":"절감","value":"대차 7일 단축 ₩700K 절감","color":"#10b981"}],"pros":["전손 당일 확정으로 최단 처리","대차 7일로 렌트비 ₩700K 절감","할부사 직접 정산으로 원스톱","잔존물 즉시 경매로 빠른 회수"],"cons":["당일 확정 위해 감정 즉시 필요","잔존물 즉시 경매 시 저가 낙찰 가능","할부사 협조 지연 가능"],"savingNote":"기존 대비 ₩5,200,000 절감","recommended":false,"strategic":true}]`;
...
const UC9_PROCESS_RESPONSE=`[{"title":"🏆 최적안: SIU 조사 후 적정가 합의","subtitle":"SIU 정밀 조사 완료 후 적정 수리비로 합의","cost":"₩2,800,000","period":"SIU 조사 7~14일 + 합의 3일","satisfaction":4.2,"actions":[{"icon":"🔍","label":"SIU 조사","value":"특별조사팀 정밀 조사","color":"#dc2626"},{"icon":"📋","label":"증거 확보","value":"CCTV·블랙박스·정비이력 분석","color":"#6366f1"},{"icon":"💰","label":"적정가","value":"₩7,500,000 → ₩2,800,000 적정화","color":"#059669"},{"icon":"🔧","label":"수리 검증","value":"실제 파손 부위만 인정","color":"#2563eb"},{"icon":"⚠️","label":"사기 기록","value":"보험사기 의심 이력 등록","color":"#d97706"},{"icon":"⏱️","label":"기간","value":"SIU 7~14일 + 합의 3일","color":"#f97316"}],"pros":["SIU 조사로 과다청구 ₩4.7M 삭감","적정가 합의로 법적 리스크 최소","사기 이력 등록으로 재발 방지","증거 기반 합리적 처리"],"cons":["SIU 조사 7~14일 소요","상대방 불만 및 민원 가능","조사 비용 발생"],"savingNote":"과다청구 ₩4,700,000 삭감","recommended":true},{"title":"⚡ 공격안: 사기 혐의 통보 + 지급 보류","subtitle":"보험사기 혐의 정식 통보 + 보험금 지급 전면 보류","cost":"₩0","period":"통보 즉시 + 수사 30~90일","satisfaction":2.0,"actions":[{"icon":"🚨","label":"사기 통보","value":"보험사기 혐의 정식 통보","color":"#dc2626"},{"icon":"🚫","label":"지급 보류","value":"보험금 전액 지급 보류","color":"#7c3aed"},{"icon":"📋","label":"수사 의뢰","value":"보험사기 수사 의뢰","color":"#6366f1"},{"icon":"⚖️","label":"법적 조치","value":"형사 고발 검토","color":"#2563eb"},{"icon":"⚠️","label":"리스크","value":"무혐의 시 역소송 + 지연이자","color":"#d97706"},{"icon":"⏱️","label":"소요","value":"수사 30~90일 장기화","color":"#f97316"}],"pros":["보험금 지급 ₩0 (최대 절감)","사기범 처벌로 재발 방지","업계 사기 억제 효과"],"cons":["무혐의 시 역소송 리스크","지연이자 발생 (연 5~12%)","수사 30~90일 장기화","금감원 민원 리스크"],"savingNote":"전액 지급 보류 (₩7,500,000)","recommended":false},{"title":"🤝 안전안: 적정가로 조기 합의 (사기 불문)","subtitle":"사기 여부 불문하고 적정가로 빠르게 합의 종결","cost":"₩4,200,000","period":"합의 3~5일","satisfaction":3.8,"actions":[{"icon":"💰","label":"적정가","value":"₩7.5M → ₩4,200,000 조정","color":"#059669"},{"icon":"🤝","label":"합의","value":"사기 불문 빠른 합의","color":"#2563eb"},{"icon":"⏱️","label":"종결","value":"3~5일 즉시 종결","color":"#059669"},{"icon":"📋","label":"기록","value":"내부 사기 의심 기록만","color":"#6366f1"},{"icon":"😊","label":"관계","value":"분쟁 없이 종결","color":"#7c3aed"},{"icon":"⚠️","label":"한계","value":"사기 재발 방지 효과 없음","color":"#d97706"}],"pros":["3~5일 빠른 종결","분쟁 비용 제로","금감원 민원 리스크 없음","적정가 수준 합의"],"cons":["사기범에게 관대한 처리","₩4.2M 지급 (과다 가능)","재발 방지 효과 없음","내부 감사 지적 가능"],"savingNote":"기존 대비 ₩3,300,000 절감","recommended":false},{"title":"💡 전략안: 부분 인정(판금분만) + 교체 청구 거부 + 사기 기록","subtitle":"판금 수리만 인정 + 부품 교체 청구 전면 거부 + 사기 DB 등록","cost":"₩1,800,000","period":"통보 3일 + 합의 5일","satisfaction":4.4,"actions":[{"icon":"🔧","label":"판금만 인정","value":"판금 수리 ₩1,800,000만 인정","color":"#2563eb"},{"icon":"🚫","label":"교체 거부","value":"부품 교체 ₩5,700,000 거부","color":"#dc2626"},{"icon":"📋","label":"사기 DB","value":"보험사기 의심 DB 등록","color":"#7c3aed"},{"icon":"📊","label":"근거","value":"SIU 조사 결과 + 정비 감정","color":"#6366f1"},{"icon":"⏱️","label":"종결","value":"통보 3일 + 합의 5일","color":"#059669"},{"icon":"📉","label":"절감","value":"교체→판금 전환 ₩5.7M 절감","color":"#10b981"}],"pros":["판금만 인정으로 ₩5.7M 절감","사기 DB 등록으로 재발 방지","SIU 근거로 법적 정당성 확보","8일 내 종결 가능"],"cons":["상대방 강력 반발 예상","부분 인정 합의 거부 가능","금감원 민원 가능성","판금 품질 이의제기"],"savingNote":"기존 대비 ₩5,700,000 절감","recommended":false,"strategic":true}]`;

// ═══ CASE 10 처리방법 프리셋 (침수+시효) ═══
const UC10_PROCESS_RESPONSE=`[{"title":"🏆 최적안: 침수 전손 즉시 확정 + 시효 내 처리","subtitle":"침수 전손 즉시 확정 + 잔존물 경매 + 시효 내 완료","cost":"₩22,000,000","period":"전손 확정 2일 + 경매 7일","satisfaction":4.4,"actions":[{"icon":"🌊","label":"침수 전손","value":"침수 전손 즉시 확정","color":"#dc2626"},{"icon":"🚗","label":"차량가액","value":"₩25,000,000 (시가 기준)","color":"#2563eb"},{"icon":"🔨","label":"잔존물","value":"경매 처리 ₩3,500,000","color":"#059669"},{"icon":"⏰","label":"시효","value":"소멸시효 내 처리 완료","color":"#7c3aed"},{"icon":"💰","label":"지급액","value":"₩25M - ₩3.5M = ₩21,500,000","color":"#f97316"},{"icon":"⏱️","label":"기간","value":"전손 2일 + 경매 7일","color":"#059669"}],"pros":["침수 전손 즉시 확정으로 빠른 처리","잔존물 경매로 ₩3.5M 회수","시효 내 처리로 법적 리스크 제거","고객 빠른 보상 수령"],"cons":["차량가액 분쟁 가능","잔존물 침수차 경매가 저조","시효 임박 시 협상력 저하"],"savingNote":"잔존물 경매 ₩3,500,000 회수","recommended":true},{"title":"⚡ 공격안: 잔존물 가치 극대화","subtitle":"잔존물 부품별 분리 매각 + 차량가액 엄격 산정","cost":"₩18,500,000","period":"감정 5일 + 분리매각 14일","satisfaction":3.3,"actions":[{"icon":"🔨","label":"분리매각","value":"잔존물 부품별 분리 ₩5,500,000","color":"#059669"},{"icon":"📊","label":"가액 산정","value":"₩25M → ₩23M (감가 적용)","color":"#dc2626"},{"icon":"🔧","label":"부품","value":"엔진·미션·전장 개별 매각","color":"#2563eb"},{"icon":"📋","label":"감정","value":"침수 등급별 부품 감정","color":"#6366f1"},{"icon":"⚠️","label":"리스크","value":"고객 반발 + 시효 압박","color":"#d97706"},{"icon":"⏱️","label":"소요","value":"감정 5일 + 분리 14일","color":"#f97316"}],"pros":["잔존물 ₩5.5M 최대 회수","차량가액 감가로 ₩2M 절감","부품별 개별 매각 수익"],"cons":["분리매각 14일 추가 소요","시효 압박으로 시간 부족 가능","고객 반발 (가액 하향)","침수 부품 매각 수요 불확실"],"savingNote":"기존 대비 ₩3,500,000 절감 (최대)","recommended":false},{"title":"🤝 안전안: 시가 감가 최소 적용","subtitle":"차량가액 시가 기준 + 감가 최소 적용 + 잔존물 인수","cost":"₩25,000,000","period":"확정 2일 + 인수 3일","satisfaction":4.3,"actions":[{"icon":"🚗","label":"시가 기준","value":"₩25,000,000 전액 인정","color":"#dc2626"},{"icon":"📉","label":"감가 최소","value":"감가 미적용 (고객 배려)","color":"#2563eb"},{"icon":"🔨","label":"잔존물","value":"보험사 인수 처리","color":"#059669"},{"icon":"⏰","label":"시효","value":"시효 내 즉시 처리","color":"#7c3aed"},{"icon":"⏱️","label":"종결","value":"2~3일 최단 종결","color":"#059669"},{"icon":"😊","label":"고객","value":"전액 보상으로 만족도 최고","color":"#f59e0b"}],"pros":["고객 만족도 최고","2~3일 최단 종결","시효 리스크 완전 제거","분쟁 비용 제로"],"cons":["자사 지급액 최대 ₩25M","잔존물 인수 후 처리 비용","감가 미적용으로 과다 지급"],"savingNote":"잔존물 인수 후 ₩2~4M 회수 예상","recommended":false},{"title":"💡 전략안: 침수 특약 활용 + 잔존물 직접 처리 + 대차 미제공","subtitle":"침수 특약 한도 활용 + 잔존물 직접 경매 + 대차 미제공","cost":"₩19,500,000","period":"확정 1일 + 경매 5일","satisfaction":4.5,"actions":[{"icon":"🌊","label":"침수 특약","value":"침수 특약 한도 ₩25M 활용","color":"#2563eb"},{"icon":"🔨","label":"직접 처리","value":"잔존물 직접 경매 ₩4,200,000","color":"#059669"},{"icon":"🚫","label":"대차 미제공","value":"전손 확정 → 대차 미제공","color":"#dc2626"},{"icon":"⏰","label":"시효","value":"1일 즉시 확정 (시효 확보)","color":"#7c3aed"},{"icon":"📉","label":"절감","value":"대차비 ₩1.4M + 잔존물 ₩4.2M","color":"#10b981"},{"icon":"⏱️","label":"종결","value":"1일 확정 + 5일 경매","color":"#059669"}],"pros":["침수 특약 활용으로 보장 극대화","잔존물 직접 경매로 ₩4.2M 회수","대차 미제공으로 ₩1.4M 절감","1일 즉시 확정으로 시효 확보"],"cons":["대차 미제공 시 고객 불만","잔존물 침수차 경매가 변동","침수 특약 미가입 시 적용 불가"],"savingNote":"기존 대비 ₩5,500,000 절감","recommended":false,"strategic":true}]`;
